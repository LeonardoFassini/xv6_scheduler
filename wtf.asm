...
_wtf: formato do arquivo elf32-i386
...
int main(){
  ...
  10:	be 0a 00 00 00       	mov    $0xa,%esi
   ...
   for(i = 0; i < arg; i++){
      ...
      if(fork(num)== 0){
  15:	bb d3 4d 62 10       	mov    $0x10624dd3,%ebx
#define arg 10
...
int main(){
  1a:	83 ec 14             	sub    $0x14,%esp
   printf(1, "working!\n");
  1d:	68 80 07 00 00       	push   $0x780
  22:	6a 01                	push   $0x1
  24:	e8 37 04 00 00       	call   460 <printf>
  29:	83 c4 10             	add    $0x10,%esp
  2c:	eb 35                	jmp    63 <main+0x63>
  2e:	66 90                	xchg   %ax,%ax
   int num;
   int i;
   for(i = 0; i < arg; i++){
...
int roulette(){
  ...
  35:	89 0d 70 0a 00 00    	mov    %ecx,0xa70
   printf(1, "working!\n");
   int num;
   int i;
   for(i = 0; i < arg; i++){
  ...
  44:	c1 f8 06             	sar    $0x6,%eax
  47:	29 d0                	sub    %edx,%eax
  49:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
  4f:	29 c1                	sub    %eax,%ecx
  51:	51                   	push   %ecx
  52:	e8 b3 02 00 00       	call   30a <fork>
  57:	83 c4 10             	add    $0x10,%esp
  5a:	85 c0                	test   %eax,%eax
  5c:	74 1b                	je     79 <main+0x79>
...
int roulette(){
   seed = (seed * 1103515245) + 12345;
  63:	69 0d 70 0a 00 00 6d 	imul   $0x41c64e6d,0xa70,%ecx
  6a:	4e c6 41 
   if(seed < 0) seed = seed * (-1);
  6d:	81 c1 39 30 00 00    	add    $0x3039,%ecx
  73:	79 bb                	jns    30 <main+0x30>
  75:	f7 d9                	neg    %ecx
  77:	eb b7                	jmp    30 <main+0x30>
  79:	eb fe                	jmp    79 <main+0x79>
  7b:	90                   	nop
  7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  80:	bb 0a 00 00 00       	mov    $0xa,%ebx
  85:	8d 76 00             	lea    0x0(%esi),%esi
   ...
   for(i = 0; i < arg; i++){
      wait();
  88:	e8 8d 02 00 00       	call   31a <wait>
         waste_time();
         printf(1, "ID: %d Tnum: %d\n", getpid(), num);
         exit();
      }
  ...
  90:	75 f6                	jne    88 <main+0x88>
   ...
   exit();
  92:	e8 7b 02 00 00       	call   312 <exit>
  97:	66 90                	xchg   %ax,%ax
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
  9d:	66 90                	xchg   %ax,%ax
...
void waste_time(){
  ...
  a3:	eb fe                	jmp    a3 <waste_time+0x3>
...
int roulette(){
   seed = (seed * 1103515245) + 12345;
  b0:	69 05 70 0a 00 00 6d 	imul   $0x41c64e6d,0xa70,%eax
  b7:	4e c6 41 
   }
}
...
int roulette(){
  ...
  bb:	89 e5                	mov    %esp,%ebp
   seed = (seed * 1103515245) + 12345;
   if(seed < 0) seed = seed * (-1);
  bd:	05 39 30 00 00       	add    $0x3039,%eax
  c2:	79 02                	jns    c6 <roulette+0x16>
  c4:	f7 d8                	neg    %eax
  c6:	a3 70 0a 00 00       	mov    %eax,0xa70
   //cprintf("%d\n", seed);
   return seed;
}
  cb:	5d                   	pop    %ebp
...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 8a 07 00 00       	mov    $0x78a,%eax
...
free(void *ap)
{
 ...
 657:	89 08                	mov    %ecx,(%eax)
  freep = p;
 659:	a3 74 0a 00 00       	mov    %eax,0xa74
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 67d:	a3 74 0a 00 00       	mov    %eax,0xa74
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6ef:	76 3f                	jbe    730 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	39 05 74 0a 00 00    	cmp    %eax,0xa74
 ...
 716:	e8 e5 fe ff ff       	call   600 <free>
  return freep;
 71b:	8b 15 74 0a 00 00    	mov    0xa74,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 73f:	89 15 74 0a 00 00    	mov    %edx,0xa74
      return (void*)(p + 1);
 ...
 754:	eb e9                	jmp    73f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 74 0a 00 00 78 	movl   $0xa78,0xa74
 75d:	0a 00 00 
 760:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 767:	0a 00 00 
    base.s.size = 0;
 76a:	b8 78 0a 00 00       	mov    $0xa78,%eax

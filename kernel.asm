...
801002e7:	e8 44 42 00 00       	call   80104530 <release>
        ilock(ip);
...
80100393:	68 8d 70 10 80       	push   $0x8010708d
...
801003a1:	e8 ba 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a6:	c7 04 24 8d 75 10 80 	movl   $0x8010758d,(%esp)
...
801003b9:	e8 62 40 00 00       	call   80104420 <getcallerpcs>
...
801003d0:	68 a9 70 10 80       	push   $0x801070a9
...
80100540:	68 ad 70 10 80       	push   $0x801070ad
...
801005b1:	0f b6 92 d8 70 10 80 	movzbl -0x7fef8f28(%edx),%edx
  }while((x /= base) != 0);
...
80100785:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        s = "(null)";
80100788:	b8 c0 70 10 80       	mov    $0x801070c0,%eax
...
801007d8:	68 c7 70 10 80       	push   $0x801070c7
...
801009a6:	68 d0 70 10 80       	push   $0x801070d0
...
80100a6a:	75 cf                	jne    80100a3b <exec+0x4b>
  ...
  if((pgdir = setupkvm()) == 0)
80100a6c:	e8 7f 5f 00 00       	call   801069f0 <setupkvm>
...
80100afc:	e8 af 61 00 00       	call   80106cb0 <allocuvm>
...
80100b32:	e8 b9 60 00 00       	call   80106bf0 <loaduvm>
...
80100b51:	e8 8a 62 00 00       	call   80106de0 <freevm>
...
80100b8d:	e8 1e 61 00 00       	call   80106cb0 <allocuvm>
...
80100bd9:	e8 82 62 00 00       	call   80106e60 <clearpteu>
  sp = sz;
...
80100c09:	e8 b2 3b 00 00       	call   801047c0 <strlen>
...
80100c1c:	e8 9f 3b 00 00       	call   801047c0 <strlen>
...
80100c2d:	e8 8e 63 00 00       	call   80106fc0 <copyout>
...
80100c91:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c97:	e8 24 63 00 00       	call   80106fc0 <copyout>
...
80100cda:	e8 a1 3a 00 00       	call   80104780 <safestrcpy>
...
80100d0e:	e8 8d 5d 00 00       	call   80106aa0 <switchuvm>
  freevm(oldpgdir);
80100d13:	89 3c 24             	mov    %edi,(%esp)
80100d16:	e8 c5 60 00 00       	call   80106de0 <freevm>
  return 0;
...
80100d36:	68 e9 70 10 80       	push   $0x801070e9
80100d3b:	68 e0 ff 10 80       	push   $0x8010ffe0
80100d40:	e8 eb 35 00 00       	call   80104330 <initlock>
}
...
80100d61:	e8 ea 35 00 00       	call   80104350 <acquire>
...
80100d91:	e8 9a 37 00 00       	call   80104530 <release>
      return f;
...
80100da8:	e8 83 37 00 00       	call   80104530 <release>
  return 0;
...
80100dcf:	e8 7c 35 00 00       	call   80104350 <acquire>
  if(f->ref < 1)
...
80100dec:	e8 3f 37 00 00       	call   80104530 <release>
  return f;
}
...
80100dfb:	68 f0 70 10 80       	push   $0x801070f0
...
80100e21:	e8 2a 35 00 00       	call   80104350 <acquire>
  if(f->ref < 1)
...
80100e4b:	5d                   	pop    %ebp
  ...
  if(--f->ref > 0){
    release(&ftable.lock);
80100e4c:	e9 df 36 00 00       	jmp    80104530 <release>
...
80100e75:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e78:	e8 b3 36 00 00       	call   80104530 <release>
...
80100ed2:	68 f8 70 10 80       	push   $0x801070f8
...
80100fb2:	68 02 71 10 80       	push   $0x80107102
...
801010c4:	68 0b 71 10 80       	push   $0x8010710b
...
801010d1:	68 11 71 10 80       	push   $0x80107111
...
80101182:	68 1b 71 10 80       	push   $0x8010711b
...
801011c5:	e8 b6 33 00 00       	call   80104580 <memset>
  log_write(bp);
...
8010120a:	e8 41 31 00 00       	call   80104350 <acquire>
...
8010124f:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101252:	e8 d9 32 00 00       	call   80104530 <release>
      return ip;
...
801012b4:	68 31 71 10 80       	push   $0x80107131
...
8010137a:	68 41 71 10 80       	push   $0x80107141
...
801013b1:	e8 7a 32 00 00       	call   80104630 <memmove>
  brelse(bp);
...
80101446:	68 54 71 10 80       	push   $0x80107154
...
801014c9:	68 c4 71 10 80       	push   $0x801071c4
...
8010155e:	e8 1d 30 00 00       	call   80104580 <memset>
      dip->type = type;
...
80101593:	68 74 71 10 80       	push   $0x80107174
...
80101601:	e8 2a 30 00 00       	call   80104630 <memmove>
  log_write(bp);
...
8010162f:	e8 1c 2d 00 00       	call   80104350 <acquire>
  ip->ref++;
80101634:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101638:	c7 04 24 00 0a 11 80 	movl   $0x80110a00,(%esp)
8010163f:	e8 ec 2e 00 00       	call   80104530 <release>
  return ip;
}
...
801016e8:	e8 43 2f 00 00       	call   80104630 <memmove>
    brelse(bp);
...
8010170a:	68 8c 71 10 80       	push   $0x8010718c
...
80101717:	68 86 71 10 80       	push   $0x80107186
...
80101743:	e8 b8 2b 00 00       	call   80104300 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
8010175f:	e9 5c 2b 00 00       	jmp    801042c0 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
80101767:	68 9b 71 10 80       	push   $0x8010719b
...
80101791:	e8 ba 2b 00 00       	call   80104350 <acquire>
...
801017b4:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
801017b5:	e9 76 2d 00 00       	jmp    80104530 <release>
...
801017de:	e8 4d 2d 00 00       	call   80104530 <release>
...
8010183f:	e8 0c 2b 00 00       	call   80104350 <acquire>
    ip->flags = 0;
...
801019b8:	e8 73 2c 00 00       	call   80104630 <memmove>
    brelse(bp);
...
80101ab4:	e8 77 2b 00 00       	call   80104630 <memmove>
    log_write(bp);
...
80101b4e:	e8 5d 2b 00 00       	call   801046b0 <strncmp>
}
80101b53:	c9                   	leave  
80101b54:	c3                   	ret    
...
80101bb5:	e8 f6 2a 00 00       	call   801046b0 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
    if(de.inum == 0)
...
80101bed:	68 b5 71 10 80       	push   $0x801071b5
...
80101bfa:	68 a3 71 10 80       	push   $0x801071a3
...
80101c3a:	e8 11 27 00 00       	call   80104350 <acquire>
  ip->ref++;
80101c3f:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c43:	c7 04 24 00 0a 11 80 	movl   $0x80110a00,(%esp)
80101c4a:	e8 e1 28 00 00       	call   80104530 <release>
...
80101ca5:	e8 86 29 00 00       	call   80104630 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101d34:	e8 f7 28 00 00       	call   80104630 <memmove>
    name[len] = 0;
...
80101e1d:	e8 fe 28 00 00       	call   80104720 <strncpy>
  de.inum = inum;
...
80101e5b:	68 b5 71 10 80       	push   $0x801071b5
...
80101e68:	68 7e 77 10 80       	push   $0x8010777e
...
80101f70:	68 20 72 10 80       	push   $0x80107220
...
80101f7d:	68 17 72 10 80       	push   $0x80107217
...
80101f96:	68 32 72 10 80       	push   $0x80107232
80101f9b:	68 80 a5 10 80       	push   $0x8010a580
80101fa0:	e8 8b 23 00 00       	call   80104330 <initlock>
  picenable(IRQ_IDE);
...
8010202e:	e8 1d 23 00 00       	call   80104350 <acquire>
  if((b = idequeue) == 0){
...
8010205e:	e8 0d 20 00 00       	call   80104070 <wakeup>
...
8010207c:	e8 af 24 00 00       	call   80104530 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801020ce:	e8 2d 22 00 00       	call   80104300 <holdingsleep>
...
80102108:	e8 43 22 00 00       	call   80104350 <acquire>
...
80102175:	c9                   	leave  
  ...
  release(&idelock);
80102176:	e9 b5 23 00 00       	jmp    80104530 <release>
...
8010218e:	68 36 72 10 80       	push   $0x80107236
...
8010219b:	68 61 72 10 80       	push   $0x80107261
...
801021a8:	68 4c 72 10 80       	push   $0x8010724c
...
80102217:	68 80 72 10 80       	push   $0x80107280
...
801022f2:	e8 89 22 00 00       	call   80104580 <memset>
...
8010232a:	c9                   	leave  
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
8010232b:	e9 00 22 00 00       	jmp    80104530 <release>
...
80102338:	e8 13 20 00 00       	call   80104350 <acquire>
...
80102345:	68 b2 72 10 80       	push   $0x801072b2
...
801023ab:	68 b8 72 10 80       	push   $0x801072b8
801023b0:	68 60 26 11 80       	push   $0x80112660
801023b5:	e8 76 1f 00 00       	call   80104330 <initlock>
...
8010249e:	e8 8d 20 00 00       	call   80104530 <release>
...
801024b8:	e8 93 1e 00 00       	call   80104350 <acquire>
  r = kmem.freelist;
...
80102944:	e8 87 1c 00 00       	call   801045d0 <memcmp>
...
80102c6d:	e8 be 18 00 00       	call   80104530 <release>
}
...
80102ccc:	e8 5f 19 00 00       	call   80104630 <memmove>
...
80102d15:	e8 36 16 00 00       	call   80104350 <acquire>
    log.committing = 0;
    wakeup(&log);
...
80102d28:	00 00 00 
    wakeup(&log);
80102d2b:	e8 40 13 00 00       	call   80104070 <wakeup>
    release(&log.lock);
80102d30:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80102d37:	e8 f4 17 00 00       	call   80104530 <release>
...
80102d58:	e8 13 13 00 00       	call   80104070 <wakeup>
  }
  release(&log.lock);
80102d5d:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80102d64:	e8 c7 17 00 00       	call   80104530 <release>
...
80102dce:	e8 7d 15 00 00       	call   80104350 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e1d:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102e1e:	e9 0d 17 00 00       	jmp    80104530 <release>
80102e23:	90                   	nop
...
80102e74:	e8 e7 d7 ff ff       	call   80100660 <cprintf>
  cprintf("hello\n");
80102e79:	c7 04 24 71 75 10 80 	movl   $0x80107571,(%esp)
80102e80:	e8 db d7 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e85:	e8 e6 29 00 00       	call   80105870 <idtinit>
...
80102e9d:	e8 de 0c 00 00       	call   80103b80 <scheduler>
...
80102eb3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102eb6:	e8 c5 3b 00 00       	call   80106a80 <switchkvm>
  seginit();
80102ebb:	e8 e0 39 00 00       	call   801068a0 <seginit>
  lapicinit();
...
80102f26:	e8 45 2c 00 00       	call   80105b70 <uartinit>
  pinit();         // process table
80102f2b:	e8 40 09 00 00       	call   80103870 <pinit>
  tvinit();        // trap vectors
80102f30:	e8 9b 28 00 00       	call   801057d0 <tvinit>
  binit();         // buffer cache
...
80102f6c:	e8 bf 16 00 00       	call   80104630 <memmove>
...
8010301a:	e8 41 fe ff ff       	call   80102e60 <mpmain>
  ...
  if(!ismp)
    timerinit();   // uniprocessor timer
8010301f:	e8 4c 27 00 00       	call   80105770 <timerinit>
...
80103058:	68 8f 75 10 80       	push   $0x8010758f
8010305d:	56                   	push   %esi
8010305e:	e8 6d 15 00 00       	call   801045d0 <memcmp>
...
80103118:	68 94 75 10 80       	push   $0x80107594
...
8010311e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103121:	e8 aa 14 00 00       	call   801045d0 <memcmp>
...
801031ac:	ff 24 95 9c 75 10 80 	jmp    *-0x7fef8a64(,%edx,4)
801031b3:	90                   	nop
...
801033d0:	00 00 00 
  initlock(&p->lock, "pipe");
801033d3:	68 b0 75 10 80       	push   $0x801075b0
801033d8:	50                   	push   %eax
801033d9:	e8 52 0f 00 00       	call   80104330 <initlock>
  (*f0)->type = FD_PIPE;
...
8010346f:	e8 dc 0e 00 00       	call   80104350 <acquire>
  if(writable){
...
801034b3:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
801034b4:	e9 77 10 00 00       	jmp    80104530 <release>
...
801034d4:	e8 97 0b 00 00       	call   80104070 <wakeup>
...
801034e4:	e8 47 10 00 00       	call   80104530 <release>
    kfree((char*)p);
...
8010350d:	e8 3e 0e 00 00       	call   80104350 <acquire>
  for(i = 0; i < n; i++){
...
80103597:	e8 d4 0a 00 00       	call   80104070 <wakeup>
...
801035f0:	e8 7b 0a 00 00       	call   80104070 <wakeup>
  release(&p->lock);
801035f5:	89 3c 24             	mov    %edi,(%esp)
801035f8:	e8 33 0f 00 00       	call   80104530 <release>
  return n;
...
8010360c:	e8 1f 0f 00 00       	call   80104530 <release>
        return -1;
...
80103640:	e8 0b 0d 00 00       	call   80104350 <acquire>
...
801036ab:	e8 80 0e 00 00       	call   80104530 <release>
      return -1;
...
8010370f:	e8 5c 09 00 00       	call   80104070 <wakeup>
  release(&p->lock);
80103714:	89 1c 24             	mov    %ebx,(%esp)
80103717:	e8 14 0e 00 00       	call   80104530 <release>
  return i;
...
80103761:	e8 ea 0b 00 00       	call   80104350 <acquire>
...
801037a7:	89 15 0c a0 10 80    	mov    %edx,0x8010a00c
  ...
  release(&ptable.lock);
801037ad:	e8 7e 0d 00 00       	call   80104530 <release>
...
801037cf:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801037d2:	c7 40 14 be 57 10 80 	movl   $0x801057be,0x14(%eax)
...
801037de:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
801037e1:	e8 9a 0d 00 00       	call   80104580 <memset>
...
80103808:	e8 23 0d 00 00       	call   80104530 <release>
  return 0;
...
8010382b:	e8 00 0d 00 00       	call   80104530 <release>
...
80103880:	e8 ab 0a 00 00       	call   80104330 <initlock>
}
...
801038a3:	e8 48 31 00 00       	call   801069f0 <setupkvm>
...
801038c1:	e8 aa 32 00 00       	call   80106b70 <inituvm>
  p->sz = PGSIZE;
...
801038d6:	e8 a5 0c 00 00       	call   80104580 <memset>
...
8010392f:	68 d5 75 10 80       	push   $0x801075d5
80103934:	50                   	push   %eax
80103935:	e8 46 0e 00 00       	call   80104780 <safestrcpy>
  p->cwd = namei("/");
8010393a:	c7 04 24 de 75 10 80 	movl   $0x801075de,(%esp)
...
80103950:	e8 fb 09 00 00       	call   80104350 <acquire>
...
8010396a:	e8 c1 0b 00 00       	call   80104530 <release>
}
...
8010397a:	68 bc 75 10 80       	push   $0x801075bc
...
801039b1:	e8 fa 32 00 00       	call   80106cb0 <allocuvm>
...
801039d0:	e8 cb 30 00 00       	call   80106aa0 <switchuvm>
  return 0;
...
801039ec:	e8 bf 33 00 00       	call   80106db0 <deallocuvm>
...
80103a70:	0f 84 dd 00 00 00    	je     80103b53 <fork+0xf3>
...
80103a86:	e8 05 34 00 00       	call   80106e90 <copyuvm>
80103a8b:	83 c4 10             	add    $0x10,%esp
80103a8e:	85 c0                	test   %eax,%eax
80103a90:	89 43 04             	mov    %eax,0x4(%ebx)
80103a93:	0f 84 c1 00 00 00    	je     80103b5a <fork+0xfa>
    kfree(np->kstack);
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
...
80103b18:	e8 63 0c 00 00       	call   80104780 <safestrcpy>
...
80103b27:	e8 24 08 00 00       	call   80104350 <acquire>

  np->state = RUNNABLE;
80103b2c:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  np->tickets = DEFAULT_T;
80103b33:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
  release(&ptable.lock);
80103b3a:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
80103b41:	e8 ea 09 00 00       	call   80104530 <release>
...
80103b58:	eb f1                	jmp    80103b4b <fork+0xeb>
  }
...
80103b60:	e8 5b e7 ff ff       	call   801022c0 <kfree>
    np->kstack = 0;
80103b65:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
80103b6c:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103b73:	83 c4 10             	add    $0x10,%esp
80103b76:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103b7b:	eb ce                	jmp    80103b4b <fork+0xeb>
...
80103b99:	e8 b2 07 00 00       	call   80104350 <acquire>
...
80103ba8:	eb 10                	jmp    80103bba <scheduler+0x3a>
80103baa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103bb0:	83 e8 80             	sub    $0xffffff80,%eax
80103bb3:	3d d4 4d 11 80       	cmp    $0x80114dd4,%eax
80103bb8:	74 13                	je     80103bcd <scheduler+0x4d>
      if(p->state == RUNNABLE) tickets += p->tickets;// cprintf("%d", p->tickets);
80103bba:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103bbe:	75 f0                	jne    80103bb0 <scheduler+0x30>
80103bc0:	03 48 7c             	add    0x7c(%eax),%ecx
}
...
int findtickets(){
   ...
   int tickets = 0;
   for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bc3:	83 e8 80             	sub    $0xffffff80,%eax
80103bc6:	3d d4 4d 11 80       	cmp    $0x80114dd4,%eax
80103bcb:	75 ed                	jne    80103bba <scheduler+0x3a>
      // Enable interrupts on this processor.
      sti();
...
80103bcd:	85 c9                	test   %ecx,%ecx
80103bcf:	7e 5f                	jle    80103c30 <scheduler+0xb0>
}
...
int roulette(){
   seed = (seed * 1103515245) + 12345;
80103bd1:	69 05 08 a0 10 80 6d 	imul   $0x41c64e6d,0x8010a008,%eax
80103bd8:	4e c6 41 
   if(seed < 0) seed = seed * (-1);
80103bdb:	05 39 30 00 00       	add    $0x3039,%eax
80103be0:	0f 88 a5 00 00 00    	js     80103c8b <scheduler+0x10b>
...
int roulette(){
   seed = (seed * 1103515245) + 12345;
   if(seed < 0) seed = seed * (-1);
80103be7:	a3 08 a0 10 80       	mov    %eax,0x8010a008
      processes = findtickets();
      if(processes > 0){ // pra ele nao tentar escalonar algum processo, quando nao existe nenhum ticket pronto;
         lucky_number = roulette();
         lucky_number = lucky_number % processes;
...
80103bee:	f7 f9                	idiv   %ecx
         ...
         for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bf0:	bb d4 2d 11 80       	mov    $0x80112dd4,%ebx
...
80103bf7:	eb 12                	jmp    80103c0b <scheduler+0x8b>
...
80103c03:	81 fb d4 4d 11 80    	cmp    $0x80114dd4,%ebx
80103c09:	74 25                	je     80103c30 <scheduler+0xb0>
            if(p->state != RUNNABLE) continue;
80103c0b:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103c0f:	75 ef                	jne    80103c00 <scheduler+0x80>
            if(p->tickets + ticketsum <= lucky_number){
80103c11:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103c14:	01 f0                	add    %esi,%eax
80103c16:	39 c7                	cmp    %eax,%edi
80103c18:	7c 2e                	jl     80103c48 <scheduler+0xc8>
         lucky_number = roulette();
         lucky_number = lucky_number % processes;
         //cprintf("%d\n", processes);
         ticketsum = 0;
         // Loop over process table looking for process to run.
         for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c1a:	83 eb 80             	sub    $0xffffff80,%ebx
80103c1d:	89 c6                	mov    %eax,%esi
80103c1f:	81 fb d4 4d 11 80    	cmp    $0x80114dd4,%ebx
80103c25:	75 e4                	jne    80103c0b <scheduler+0x8b>
...
80103c38:	e8 f3 08 00 00       	call   80104530 <release>
   }
...
80103c53:	e8 48 2e 00 00       	call   80106aa0 <switchuvm>
            p->state = RUNNING;
...
80103c6e:	e8 68 0b 00 00       	call   801047db <swtch>
            switchkvm();
80103c73:	e8 08 2e 00 00       	call   80106a80 <switchkvm>

            // Process is done running for now.
            // It should have changed its p->state before coming back.
            proc = 0;
80103c78:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80103c7f:	00 00 00 00 
80103c83:	83 c4 10             	add    $0x10,%esp
80103c86:	e9 75 ff ff ff       	jmp    80103c00 <scheduler+0x80>
...
int roulette(){
   seed = (seed * 1103515245) + 12345;
   if(seed < 0) seed = seed * (-1);
80103c8b:	f7 d8                	neg    %eax
80103c8d:	e9 54 ff ff ff       	jmp    80103be6 <scheduler+0x66>
...
80103cac:	e8 cf 07 00 00       	call   80104480 <holding>
...
80103ceb:	e8 eb 0a 00 00       	call   801047db <swtch>
  cpu->intena = intena;
...
80103d07:	68 e0 75 10 80       	push   $0x801075e0
...
80103d14:	68 0c 76 10 80       	push   $0x8010760c
...
80103d21:	68 fe 75 10 80       	push   $0x801075fe
...
80103d2e:	68 f2 75 10 80       	push   $0x801075f2
...
80103d51:	53                   	push   %ebx
  ...
  if(proc == initproc)
80103d52:	0f 84 1f 01 00 00    	je     80103e77 <exit+0x137>
...
80103dbd:	e8 8e 05 00 00       	call   80104350 <acquire>
...
80103dd4:	eb 14                	jmp    80103dea <exit+0xaa>
...
80103de3:	3d d4 4d 11 80       	cmp    $0x80114dd4,%eax
80103de8:	74 1c                	je     80103e06 <exit+0xc6>
    if(p->state == SLEEPING && p->chan == chan)
80103dea:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103dee:	75 f0                	jne    80103de0 <exit+0xa0>
80103df0:	3b 50 20             	cmp    0x20(%eax),%edx
80103df3:	75 eb                	jne    80103de0 <exit+0xa0>
      p->state = RUNNABLE;
...
80103dff:	3d d4 4d 11 80       	cmp    $0x80114dd4,%eax
80103e04:	75 e4                	jne    80103dea <exit+0xaa>
  wakeup1(proc->parent);
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == proc){
      p->parent = initproc;
80103e06:	8b 1d bc a5 10 80    	mov    0x8010a5bc,%ebx
80103e0c:	ba d4 2d 11 80       	mov    $0x80112dd4,%edx
80103e11:	eb 10                	jmp    80103e23 <exit+0xe3>
80103e13:	90                   	nop
...
80103e1b:	81 fa d4 4d 11 80    	cmp    $0x80114dd4,%edx
80103e21:	74 3b                	je     80103e5e <exit+0x11e>
    if(p->parent == proc){
80103e23:	3b 4a 14             	cmp    0x14(%edx),%ecx
80103e26:	75 f0                	jne    80103e18 <exit+0xd8>
      p->parent = initproc;
      if(p->state == ZOMBIE)
80103e28:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == proc){
      p->parent = initproc;
80103e2c:	89 5a 14             	mov    %ebx,0x14(%edx)
      if(p->state == ZOMBIE)
80103e2f:	75 e7                	jne    80103e18 <exit+0xd8>
80103e31:	b8 d4 2d 11 80       	mov    $0x80112dd4,%eax
80103e36:	eb 12                	jmp    80103e4a <exit+0x10a>
80103e38:	90                   	nop
...
80103e43:	3d d4 4d 11 80       	cmp    $0x80114dd4,%eax
80103e48:	74 ce                	je     80103e18 <exit+0xd8>
    if(p->state == SLEEPING && p->chan == chan)
...
80103e5c:	eb e2                	jmp    80103e40 <exit+0x100>
  ...
  proc->state = ZOMBIE;
80103e5e:	c7 41 0c 05 00 00 00 	movl   $0x5,0xc(%ecx)
  sched();
80103e65:	e8 36 fe ff ff       	call   80103ca0 <sched>
  panic("zombie exit");
80103e6a:	83 ec 0c             	sub    $0xc,%esp
80103e6d:	68 2d 76 10 80       	push   $0x8010762d
...
80103e7a:	68 20 76 10 80       	push   $0x80107620
...
80103e9b:	e8 b0 04 00 00       	call   80104350 <acquire>
  proc->state = RUNNABLE;
...
80103eb9:	e8 72 06 00 00       	call   80104530 <release>
}
...
80103f09:	e8 22 06 00 00       	call   80104530 <release>
  }
...
80103f37:	e8 f4 05 00 00       	call   80104530 <release>
    acquire(lk);
...
80103f47:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103f48:	e9 03 04 00 00       	jmp    80104350 <acquire>
...
80103f76:	68 3f 76 10 80       	push   $0x8010763f
...
80103f83:	68 39 76 10 80       	push   $0x80107639
...
80103f9d:	e8 ae 03 00 00       	call   80104350 <acquire>
...
80103fb2:	eb 0f                	jmp    80103fc3 <wait+0x33>
80103fb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103fb8:	83 eb 80             	sub    $0xffffff80,%ebx
80103fbb:	81 fb d4 4d 11 80    	cmp    $0x80114dd4,%ebx
80103fc1:	74 1d                	je     80103fe0 <wait+0x50>
      if(p->parent != proc)
80103fc3:	3b 43 14             	cmp    0x14(%ebx),%eax
80103fc6:	75 f0                	jne    80103fb8 <wait+0x28>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80103fc8:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103fcc:	74 30                	je     80103ffe <wait+0x6e>
...
80103fce:	83 eb 80             	sub    $0xffffff80,%ebx
      if(p->parent != proc)
        continue;
      havekids = 1;
80103fd1:	ba 01 00 00 00       	mov    $0x1,%edx
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fd6:	81 fb d4 4d 11 80    	cmp    $0x80114dd4,%ebx
80103fdc:	75 e5                	jne    80103fc3 <wait+0x33>
...
80103fe2:	74 70                	je     80104054 <wait+0xc4>
80103fe4:	8b 50 24             	mov    0x24(%eax),%edx
80103fe7:	85 d2                	test   %edx,%edx
80103fe9:	75 69                	jne    80104054 <wait+0xc4>
      release(&ptable.lock);
      return -1;
    }
...
80103fee:	68 a0 2d 11 80       	push   $0x80112da0
80103ff3:	50                   	push   %eax
80103ff4:	e8 d7 fe ff ff       	call   80103ed0 <sleep>
  }
80103ff9:	83 c4 10             	add    $0x10,%esp
80103ffc:	eb a7                	jmp    80103fa5 <wait+0x15>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
...
80104001:	ff 73 08             	pushl  0x8(%ebx)
      if(p->parent != proc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
80104004:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104007:	e8 b4 e2 ff ff       	call   801022c0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
8010400c:	59                   	pop    %ecx
8010400d:	ff 73 04             	pushl  0x4(%ebx)
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
80104010:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104017:	e8 c4 2d 00 00       	call   80106de0 <freevm>
        p->pid = 0;
8010401c:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104023:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
8010402a:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
8010402e:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80104035:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010403c:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
...
80104057:	68 a0 2d 11 80       	push   $0x80112da0
8010405c:	e8 cf 04 00 00       	call   80104530 <release>
      return -1;
...
8010407f:	e8 cc 02 00 00       	call   80104350 <acquire>
...
80104093:	3d d4 4d 11 80       	cmp    $0x80114dd4,%eax
...
801040af:	3d d4 4d 11 80       	cmp    $0x80114dd4,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
801040b6:	c7 45 08 a0 2d 11 80 	movl   $0x80112da0,0x8(%ebp)
}
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
801040c1:	e9 6a 04 00 00       	jmp    80104530 <release>
...
801040d7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801040da:	68 a0 2d 11 80       	push   $0x80112da0
801040df:	e8 6c 02 00 00       	call   80104350 <acquire>
801040e4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040e7:	b8 d4 2d 11 80       	mov    $0x80112dd4,%eax
...
801040f8:	74 3e                	je     80104138 <kill+0x68>
    if(p->pid == pid){
...
80104103:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010410a:	74 1c                	je     80104128 <kill+0x58>
        p->state = RUNNABLE;
      release(&ptable.lock);
8010410c:	83 ec 0c             	sub    $0xc,%esp
8010410f:	68 a0 2d 11 80       	push   $0x80112da0
80104114:	e8 17 04 00 00       	call   80104530 <release>
      return 0;
...
8010412f:	eb db                	jmp    8010410c <kill+0x3c>
...
8010413b:	68 a0 2d 11 80       	push   $0x80112da0
80104140:	e8 eb 03 00 00       	call   80104530 <release>
  return -1;
...
80104169:	bb 40 2e 11 80       	mov    $0x80112e40,%ebx
...
8010417b:	68 8d 75 10 80       	push   $0x8010758d
...
80104188:	83 eb 80             	sub    $0xffffff80,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010418b:	81 fb 40 4e 11 80    	cmp    $0x80114e40,%ebx
...
8010419e:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
801041a1:	ba 50 76 10 80       	mov    $0x80107650,%edx
  uint pc[10];
...
801041a8:	8b 14 85 88 76 10 80 	mov    -0x7fef8978(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801041af:	b8 50 76 10 80       	mov    $0x80107650,%eax
...
801041be:	68 54 76 10 80       	push   $0x80107654
...
801041cf:	75 a7                	jne    80104178 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801041d1:	8d 45 c0             	lea    -0x40(%ebp),%eax
...
801041e5:	e8 36 02 00 00       	call   80104420 <getcallerpcs>
...
801041fd:	68 a9 70 10 80       	push   $0x801070a9
...
8010422a:	68 a0 76 10 80       	push   $0x801076a0
...
8010426f:	e8 dc 00 00 00       	call   80104350 <acquire>
  while (lk->locked) {
...
8010429f:	8b 40 10             	mov    0x10(%eax),%eax
801042a2:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
801042a5:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801042ad:	5d                   	pop    %ebp
  ...
  lk->pid = proc->pid;
  release(&lk->lk);
801042ae:	e9 7d 02 00 00       	jmp    80104530 <release>
...
801042cf:	e8 7c 00 00 00       	call   80104350 <acquire>
  lk->locked = 0;
...
801042e4:	e8 87 fd ff ff       	call   80104070 <wakeup>
  release(&lk->lk);
...
801042f4:	5d                   	pop    %ebp
{
  ...
  wakeup(lk);
  release(&lk->lk);
801042f5:	e9 36 02 00 00       	jmp    80104530 <release>
...
8010430f:	e8 3c 00 00 00       	call   80104350 <acquire>
  r = lk->locked;
80104314:	8b 36                	mov    (%esi),%esi
  release(&lk->lk);
80104316:	89 1c 24             	mov    %ebx,(%esp)
80104319:	e8 12 02 00 00       	call   80104530 <release>
  return r;
}
...
80104359:	fa                   	cli    
{
  ...
  cli();
  if(cpu->ncli == 0)
8010435a:	65 8b 0d 00 00 00 00 	mov    %gs:0x0,%ecx
80104361:	8b 81 ac 00 00 00    	mov    0xac(%ecx),%eax
80104367:	85 c0                	test   %eax,%eax
80104369:	75 0c                	jne    80104377 <acquire+0x27>
    cpu->intena = eflags & FL_IF;
8010436b:	81 e2 00 02 00 00    	and    $0x200,%edx
80104371:	89 91 b0 00 00 00    	mov    %edx,0xb0(%ecx)
// other CPUs to waste time spinning to acquire it.
void
acquire(struct spinlock *lk)
{
...
80104377:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  if(cpu->ncli == 0)
    cpu->intena = eflags & FL_IF;
  cpu->ncli += 1;
8010437a:	83 c0 01             	add    $0x1,%eax
8010437d:	89 81 ac 00 00 00    	mov    %eax,0xac(%ecx)
...
80104383:	8b 02                	mov    (%edx),%eax
80104385:	85 c0                	test   %eax,%eax
80104387:	74 05                	je     8010438e <acquire+0x3e>
80104389:	39 4a 08             	cmp    %ecx,0x8(%edx)
8010438c:	74 7a                	je     80104408 <acquire+0xb8>
xchg(volatile uint *addr, uint newval)
{
  uint result;
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
8010438e:	b9 01 00 00 00       	mov    $0x1,%ecx
80104393:	90                   	nop
80104394:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104398:	89 c8                	mov    %ecx,%eax
8010439a:	f0 87 02             	lock xchg %eax,(%edx)
  pushcli(); // disable interrupts to avoid deadlock.
  if(holding(lk))
    panic("acquire");
...
8010439f:	75 f7                	jne    80104398 <acquire+0x48>
    ;
  ...
  __sync_synchronize();
801043a1:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
...
801043af:	89 ea                	mov    %ebp,%edx
  ...
  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801043b1:	89 41 08             	mov    %eax,0x8(%ecx)
  getcallerpcs(&lk, lk->pcs);
801043b4:	83 c1 0c             	add    $0xc,%ecx
{
  uint *ebp;
  int i;
...
801043cc:	77 1a                	ja     801043e8 <acquire+0x98>
      break;
...
801043f5:	74 e7                	je     801043de <acquire+0x8e>
    pcs[i] = 0;
...
80104404:	75 e2                	jne    801043e8 <acquire+0x98>
80104406:	eb d6                	jmp    801043de <acquire+0x8e>
void
acquire(struct spinlock *lk)
{
  pushcli(); // disable interrupts to avoid deadlock.
...
8010440b:	68 ab 76 10 80       	push   $0x801076ab
80104410:	e8 5b bf ff ff       	call   80100370 <panic>
...
80104483:	8b 55 08             	mov    0x8(%ebp),%edx
  return lock->locked && lock->cpu == cpu;
80104486:	8b 02                	mov    (%edx),%eax
80104488:	85 c0                	test   %eax,%eax
8010448a:	74 14                	je     801044a0 <holding+0x20>
8010448c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104492:	39 42 08             	cmp    %eax,0x8(%edx)
}
80104495:	5d                   	pop    %ebp
...
{
  return lock->locked && lock->cpu == cpu;
80104496:	0f 94 c0             	sete   %al
80104499:	0f b6 c0             	movzbl %al,%eax
}
8010449c:	c3                   	ret    
...
801044b5:	fa                   	cli    
  ...
  cli();
  if(cpu->ncli == 0)
801044b6:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801044bd:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
801044c3:	85 c0                	test   %eax,%eax
801044c5:	75 0c                	jne    801044d3 <pushcli+0x23>
    cpu->intena = eflags & FL_IF;
801044c7:	81 e1 00 02 00 00    	and    $0x200,%ecx
801044cd:	89 8a b0 00 00 00    	mov    %ecx,0xb0(%edx)
  cpu->ncli += 1;
801044d3:	83 c0 01             	add    $0x1,%eax
801044d6:	89 82 ac 00 00 00    	mov    %eax,0xac(%edx)
}
801044dc:	5d                   	pop    %ebp
801044dd:	c3                   	ret    
...
801044eb:	75 2c                	jne    80104519 <popcli+0x39>
    panic("popcli - interruptible");
  if(--cpu->ncli < 0)
801044ed:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801044f4:	83 aa ac 00 00 00 01 	subl   $0x1,0xac(%edx)
801044fb:	78 0f                	js     8010450c <popcli+0x2c>
    panic("popcli");
  if(cpu->ncli == 0 && cpu->intena)
801044fd:	75 0b                	jne    8010450a <popcli+0x2a>
801044ff:	8b 82 b0 00 00 00    	mov    0xb0(%edx),%eax
80104505:	85 c0                	test   %eax,%eax
80104507:	74 01                	je     8010450a <popcli+0x2a>
}
...
8010450f:	68 ca 76 10 80       	push   $0x801076ca
80104514:	e8 57 be ff ff       	call   80100370 <panic>
...
8010451c:	68 b3 76 10 80       	push   $0x801076b3
...
{
  return lock->locked && lock->cpu == cpu;
80104539:	8b 10                	mov    (%eax),%edx
8010453b:	85 d2                	test   %edx,%edx
8010453d:	74 0c                	je     8010454b <release+0x1b>
8010453f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104546:	39 50 08             	cmp    %edx,0x8(%eax)
80104549:	74 15                	je     80104560 <release+0x30>
// Release the lock.
void
release(struct spinlock *lk)
{
...
8010454e:	68 d1 76 10 80       	push   $0x801076d1
80104553:	e8 18 be ff ff       	call   80100370 <panic>
80104558:	90                   	nop
80104559:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

  lk->pcs[0] = 0;
80104560:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104567:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  // Tell the C compiler and the processor to not move loads or stores
...
80104573:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
80104579:	c9                   	leave  
  ...
  popcli();
8010457a:	e9 61 ff ff ff       	jmp    801044e0 <popcli>
8010457f:	90                   	nop
...
80104878:	89 e5                	mov    %esp,%ebp
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
8010487a:	8b 42 18             	mov    0x18(%edx),%eax
8010487d:	8b 4d 08             	mov    0x8(%ebp),%ecx
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
801048c4:	8b 49 44             	mov    0x44(%ecx),%ecx
801048c7:	8d 1c 99             	lea    (%ecx,%ebx,4),%ebx
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
801048d1:	8d 73 04             	lea    0x4(%ebx),%esi
...
{
  if(addr >= proc->sz || addr+4 > proc->sz)
801048d4:	39 ce                	cmp    %ecx,%esi
801048d6:	73 1f                	jae    801048f7 <argptr+0x47>
801048d8:	8d 73 08             	lea    0x8(%ebx),%esi
801048db:	39 f1                	cmp    %esi,%ecx
801048dd:	72 18                	jb     801048f7 <argptr+0x47>
{
  int i;
...
fetchint(uint addr, int *ip)
{
  if(addr >= proc->sz || addr+4 > proc->sz)
    return -1;
  *ip = *(int*)(addr);
801048e1:	8b 5b 04             	mov    0x4(%ebx),%ebx
{
  int i;
  ...
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= proc->sz || (uint)i+size > proc->sz)
801048e4:	78 11                	js     801048f7 <argptr+0x47>
801048e6:	39 cb                	cmp    %ecx,%ebx
801048e8:	73 0d                	jae    801048f7 <argptr+0x47>
801048ea:	01 da                	add    %ebx,%edx
801048ec:	39 ca                	cmp    %ecx,%edx
801048ee:	77 07                	ja     801048f7 <argptr+0x47>
    return -1;
  *pp = (char*)i;
801048f0:	8b 45 0c             	mov    0xc(%ebp),%eax
801048f3:	89 18                	mov    %ebx,(%eax)
  return 0;
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
80104909:	8b 50 18             	mov    0x18(%eax),%edx
...
80104962:	77 f4                	ja     80104958 <argstr+0x58>
80104964:	eb bf                	jmp    80104925 <argstr+0x25>
...
80104997:	83 f9 14             	cmp    $0x14,%ecx
8010499a:	77 1c                	ja     801049b8 <syscall+0x38>
8010499c:	8b 0c 85 00 77 10 80 	mov    -0x7fef8900(,%eax,4),%ecx
...
801049ac:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801049af:	c9                   	leave  
801049b0:	c3                   	ret    
...
801049b8:	50                   	push   %eax
            proc->pid, proc->name, num);
801049b9:	8d 42 6c             	lea    0x6c(%edx),%eax
...
801049bd:	ff 72 10             	pushl  0x10(%edx)
801049c0:	68 d9 76 10 80       	push   $0x801076d9
...
801049d6:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80104a07:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
80104a0a:	e8 91 d4 ff ff       	call   80101ea0 <nameiparent>
...
80104a2e:	e8 2d d1 ff ff       	call   80101b60 <dirlookup>
...
80104a40:	e8 7b ce ff ff       	call   801018c0 <iunlockput>
    ilock(ip);
80104a45:	89 1c 24             	mov    %ebx,(%esp)
80104a48:	e8 03 cc ff ff       	call   80101650 <ilock>
...
80104a74:	e8 47 ce ff ff       	call   801018c0 <iunlockput>
    return 0;
...
80104a9a:	e8 41 ca ff ff       	call   801014e0 <ialloc>
...
80104ad1:	e8 ca ca ff ff       	call   801015a0 <iupdate>
...
80104ae8:	e8 d3 d2 ff ff       	call   80101dc0 <dirlink>
...
80104af8:	e8 c3 cd ff ff       	call   801018c0 <iunlockput>
...
80104b29:	e8 72 ca ff ff       	call   801015a0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104b2e:	83 c4 0c             	add    $0xc,%esp
80104b31:	ff 73 04             	pushl  0x4(%ebx)
80104b34:	68 74 77 10 80       	push   $0x80107774
80104b39:	53                   	push   %ebx
80104b3a:	e8 81 d2 ff ff       	call   80101dc0 <dirlink>
...
80104b4c:	68 73 77 10 80       	push   $0x80107773
80104b51:	53                   	push   %ebx
80104b52:	e8 69 d2 ff ff       	call   80101dc0 <dirlink>
...
80104b61:	68 67 77 10 80       	push   $0x80107767
...
80104b6e:	68 76 77 10 80       	push   $0x80107776
...
80104b7b:	68 58 77 10 80       	push   $0x80107758
...
80104ba2:	e8 c9 fc ff ff       	call   80104870 <argint>
80104ba7:	83 c4 10             	add    $0x10,%esp
80104baa:	85 c0                	test   %eax,%eax
80104bac:	78 3a                	js     80104be8 <argfd.constprop.0+0x58>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80104bae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bb1:	83 f8 0f             	cmp    $0xf,%eax
80104bb4:	77 32                	ja     80104be8 <argfd.constprop.0+0x58>
80104bb6:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104bbd:	8b 54 82 28          	mov    0x28(%edx,%eax,4),%edx
80104bc1:	85 d2                	test   %edx,%edx
80104bc3:	74 23                	je     80104be8 <argfd.constprop.0+0x58>
    return -1;
  if(pfd)
80104bc5:	85 f6                	test   %esi,%esi
80104bc7:	74 02                	je     80104bcb <argfd.constprop.0+0x3b>
    *pfd = fd;
80104bc9:	89 06                	mov    %eax,(%esi)
  if(pf)
80104bcb:	85 db                	test   %ebx,%ebx
80104bcd:	74 11                	je     80104be0 <argfd.constprop.0+0x50>
    *pf = f;
80104bcf:	89 13                	mov    %edx,(%ebx)
  return 0;
...
80104be2:	eb ef                	jmp    80104bd3 <argfd.constprop.0+0x43>
...
80104bed:	eb e4                	jmp    80104bd3 <argfd.constprop.0+0x43>
80104bef:	90                   	nop
...
sys_dup(void)
{
80104bf9:	83 ec 14             	sub    $0x14,%esp
  struct file *f;
  int fd;

  if(argfd(0, 0, &f) < 0)
80104bfc:	e8 8f ff ff ff       	call   80104b90 <argfd.constprop.0>
80104c01:	85 c0                	test   %eax,%eax
80104c03:	78 1b                	js     80104c20 <sys_dup+0x30>
    return -1;
  if((fd=fdalloc(f)) < 0)
80104c05:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
80104c0e:	31 db                	xor    %ebx,%ebx
    if(proc->ofile[fd] == 0){
80104c10:	8b 4c 98 28          	mov    0x28(%eax,%ebx,4),%ecx
...
80104c30:	83 ec 0c             	sub    $0xc,%esp
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
80104c33:	89 54 98 28          	mov    %edx,0x28(%eax,%ebx,4)
  ...
  if((fd=fdalloc(f)) < 0)
    return -1;
  filedup(f);
80104c37:	52                   	push   %edx
80104c38:	e8 83 c1 ff ff       	call   80100dc0 <filedup>
  return fd;
...
80104c6d:	e8 fe fb ff ff       	call   80104870 <argint>
...
80104c85:	e8 26 fc ff ff       	call   801048b0 <argptr>
...
80104c9d:	e8 8e c2 ff ff       	call   80100f30 <fileread>
...
80104cdd:	e8 8e fb ff ff       	call   80104870 <argint>
...
80104cf5:	e8 b6 fb ff ff       	call   801048b0 <argptr>
...
80104d0d:	e8 ae c2 ff ff       	call   80100fc0 <filewrite>
...
80104d43:	78 2b                	js     80104d70 <sys_close+0x40>
    return -1;
  proc->ofile[fd] = 0;
80104d45:	8b 55 f0             	mov    -0x10(%ebp),%edx
...
80104d4e:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(argfd(0, &fd, &f) < 0)
    return -1;
  proc->ofile[fd] = 0;
80104d51:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104d58:	00 
  fileclose(f);
80104d59:	ff 75 f4             	pushl  -0xc(%ebp)
80104d5c:	e8 af c0 ff ff       	call   80100e10 <fileclose>
  return 0;
...
80104d9f:	e8 0c fb ff ff       	call   801048b0 <argptr>
...
80104db4:	e8 27 c1 ff ff       	call   80100ee0 <filestat>
...
80104ddf:	e8 1c fb ff ff       	call   80104900 <argstr>
...
80104df8:	e8 03 fb ff ff       	call   80104900 <argstr>
...
80104e13:	e8 68 d0 ff ff       	call   80101e80 <namei>
...
80104e29:	e8 22 c8 ff ff       	call   80101650 <ilock>
  if(ip->type == T_DIR){
...
80104e48:	e8 53 c7 ff ff       	call   801015a0 <iupdate>
  iunlock(ip);
80104e4d:	89 1c 24             	mov    %ebx,(%esp)
80104e50:	e8 db c8 ff ff       	call   80101730 <iunlock>
...
80104e5b:	e8 40 d0 ff ff       	call   80101ea0 <nameiparent>
...
80104e6d:	e8 de c7 ff ff       	call   80101650 <ilock>
...
80104e83:	e8 38 cf ff ff       	call   80101dc0 <dirlink>
...
80104e93:	e8 28 ca ff ff       	call   801018c0 <iunlockput>
  iput(ip);
80104e98:	89 1c 24             	mov    %ebx,(%esp)
80104e9b:	e8 e0 c8 ff ff       	call   80101780 <iput>
...
80104ebc:	e8 ff c9 ff ff       	call   801018c0 <iunlockput>
    goto bad;
...
80104ed5:	e8 c6 c6 ff ff       	call   801015a0 <iupdate>
  iunlockput(ip);
80104eda:	89 1c 24             	mov    %ebx,(%esp)
80104edd:	e8 de c9 ff ff       	call   801018c0 <iunlockput>
  end_op();
...
80104f04:	e8 b7 c9 ff ff       	call   801018c0 <iunlockput>
    end_op();
80104f09:	e8 12 dd ff ff       	call   80102c20 <end_op>
    return -1;
...
80104f16:	eb 92                	jmp    80104eaa <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
80104f18:	e8 03 dd ff ff       	call   80102c20 <end_op>
    return -1;
...
80104f3f:	e8 bc f9 ff ff       	call   80104900 <argstr>
...
80104f5e:	e8 3d cf ff ff       	call   80101ea0 <nameiparent>
...
80104f78:	e8 d3 c6 ff ff       	call   80101650 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104f7d:	58                   	pop    %eax
80104f7e:	5a                   	pop    %edx
80104f7f:	68 74 77 10 80       	push   $0x80107774
80104f84:	53                   	push   %ebx
80104f85:	e8 b6 cb ff ff       	call   80101b40 <namecmp>
...
80104f98:	68 73 77 10 80       	push   $0x80107773
80104f9d:	53                   	push   %ebx
80104f9e:	e8 9d cb ff ff       	call   80101b40 <namecmp>
...
80104fb7:	e8 a4 cb ff ff       	call   80101b60 <dirlookup>
...
80104fcd:	e8 7e c6 ff ff       	call   80101650 <ilock>
...
80105000:	e8 0b ca ff ff       	call   80101a10 <writei>
...
80105022:	e8 99 c8 ff ff       	call   801018c0 <iunlockput>

  ip->nlink--;
80105027:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010502c:	89 1c 24             	mov    %ebx,(%esp)
8010502f:	e8 6c c5 ff ff       	call   801015a0 <iupdate>
  iunlockput(ip);
80105034:	89 1c 24             	mov    %ebx,(%esp)
80105037:	e8 84 c8 ff ff       	call   801018c0 <iunlockput>

  end_op();
8010503c:	e8 df db ff ff       	call   80102c20 <end_op>
...
80105071:	e8 9a c8 ff ff       	call   80101910 <readi>
...
80105089:	e8 32 c8 ff ff       	call   801018c0 <iunlockput>
    goto bad;
...
80105097:	e8 24 c8 ff ff       	call   801018c0 <iunlockput>
  end_op();
8010509c:	e8 7f db ff ff       	call   80102c20 <end_op>
  return -1;
...
801050c4:	e8 d7 c4 ff ff       	call   801015a0 <iupdate>
...
801050d6:	e9 6b ff ff ff       	jmp    80105046 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
801050db:	e8 40 db ff ff       	call   80102c20 <end_op>
    return -1;
...
801050ed:	68 98 77 10 80       	push   $0x80107798
...
801050fa:	68 aa 77 10 80       	push   $0x801077aa
...
80105107:	68 86 77 10 80       	push   $0x80107786
...
8010512f:	e8 cc f7 ff ff       	call   80104900 <argstr>
...
80105148:	e8 23 f7 ff ff       	call   80104870 <argint>
...
8010516d:	e8 0e cd ff ff       	call   80101e80 <namei>
80105172:	83 c4 10             	add    $0x10,%esp
80105175:	85 c0                	test   %eax,%eax
80105177:	89 c7                	mov    %eax,%edi
...
80105183:	e8 c8 c4 ff ff       	call   80101650 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105188:	83 c4 10             	add    $0x10,%esp
8010518b:	66 83 7f 50 01       	cmpw   $0x1,0x50(%edi)
...
80105196:	e8 b5 bb ff ff       	call   80100d50 <filealloc>
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
801051b0:	8b 44 9a 28          	mov    0x28(%edx,%ebx,4),%eax
...
801051c4:	e8 47 bc ff ff       	call   80100e10 <fileclose>
801051c9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801051cc:	83 ec 0c             	sub    $0xc,%esp
801051cf:	57                   	push   %edi
801051d0:	e8 eb c6 ff ff       	call   801018c0 <iunlockput>
    end_op();
801051d5:	e8 46 da ff ff       	call   80102c20 <end_op>
    return -1;
...
80105220:	83 ec 0c             	sub    $0xc,%esp
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
80105223:	89 74 9a 28          	mov    %esi,0x28(%edx,%ebx,4)
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
80105228:	e8 03 c5 ff ff       	call   80101730 <iunlock>
  end_op();
8010522d:	e8 ee d9 ff ff       	call   80102c20 <end_op>

  f->type = FD_INODE;
80105232:	c7 06 02 00 00 00    	movl   $0x2,(%esi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
...
8010523b:	83 c4 10             	add    $0x10,%esp
  ...
  f->type = FD_INODE;
  f->ip = ip;
8010523e:	89 7e 10             	mov    %edi,0x10(%esi)
  f->off = 0;
80105241:	c7 46 14 00 00 00 00 	movl   $0x0,0x14(%esi)
  f->readable = !(omode & O_WRONLY);
...
80105250:	83 e2 03             	and    $0x3,%edx
  ...
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105253:	88 46 08             	mov    %al,0x8(%esi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105256:	0f 95 46 09          	setne  0x9(%esi)
  return fd;
...
80105294:	e8 67 f6 ff ff       	call   80104900 <argstr>
...
801052af:	e8 3c f7 ff ff       	call   801049f0 <create>
...
801052bf:	e8 fc c5 ff ff       	call   801018c0 <iunlockput>
  end_op();
...
801052f4:	e8 07 f6 ff ff       	call   80104900 <argstr>
...
80105309:	e8 62 f5 ff ff       	call   80104870 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
8010531e:	e8 4d f5 ff ff       	call   80104870 <argint>
  char *path;
  int major, minor;
...
8010533e:	e8 ad f6 ff ff       	call   801049f0 <create>
...
8010534e:	e8 6d c5 ff ff       	call   801018c0 <iunlockput>
  end_op();
...
801053a9:	e8 a2 c2 ff ff       	call   80101650 <ilock>
  if(ip->type != T_DIR){
801053ae:	83 c4 10             	add    $0x10,%esp
801053b1:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801053b6:	75 38                	jne    801053f0 <sys_chdir+0x80>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
801053bc:	e8 6f c3 ff ff       	call   80101730 <iunlock>
  iput(proc->cwd);
801053c1:	58                   	pop    %eax
801053c2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053c8:	ff 70 68             	pushl  0x68(%eax)
...
801053db:	83 c4 10             	add    $0x10,%esp
  ...
  end_op();
  proc->cwd = ip;
801053de:	89 58 68             	mov    %ebx,0x68(%eax)
  return 0;
801053e1:	31 c0                	xor    %eax,%eax
}
801053e3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801053e6:	c9                   	leave  
801053e7:	c3                   	ret    
801053e8:	90                   	nop
...
8010541a:	eb c7                	jmp    801053e3 <sys_chdir+0x73>
...
80105435:	e8 c6 f4 ff ff       	call   80104900 <argstr>
...
8010544d:	e8 1e f4 ff ff       	call   80104870 <argint>
...
801054a9:	e8 72 f3 ff ff       	call   80104820 <fetchstr>
...
80105511:	e8 9a f3 ff ff       	call   801048b0 <argptr>
80105516:	83 c4 10             	add    $0x10,%esp
80105519:	85 c0                	test   %eax,%eax
8010551b:	78 48                	js     80105565 <sys_pipe+0x65>
    return -1;
...
80105528:	e8 33 de ff ff       	call   80103360 <pipealloc>
8010552d:	83 c4 10             	add    $0x10,%esp
80105530:	85 c0                	test   %eax,%eax
80105532:	78 31                	js     80105565 <sys_pipe+0x65>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105534:	8b 5d e0             	mov    -0x20(%ebp),%ebx
80105537:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010553e:	31 c0                	xor    %eax,%eax
    if(proc->ofile[fd] == 0){
80105540:	8b 54 81 28          	mov    0x28(%ecx,%eax,4),%edx
...
8010554b:	83 f8 10             	cmp    $0x10,%eax
...
80105554:	e8 b7 b8 ff ff       	call   80100e10 <fileclose>
    fileclose(wf);
80105559:	58                   	pop    %eax
8010555a:	ff 75 e4             	pushl  -0x1c(%ebp)
8010555d:	e8 ae b8 ff ff       	call   80100e10 <fileclose>
    return -1;
80105562:	83 c4 10             	add    $0x10,%esp
80105565:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010556a:	eb 45                	jmp    801055b1 <sys_pipe+0xb1>
8010556c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105570:	8d 34 81             	lea    (%ecx,%eax,4),%esi
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
    return -1;
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105573:	8b 7d e4             	mov    -0x1c(%ebp),%edi
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105576:	31 d2                	xor    %edx,%edx
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
80105578:	89 5e 28             	mov    %ebx,0x28(%esi)
8010557b:	90                   	nop
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
80105580:	83 7c 91 28 00       	cmpl   $0x0,0x28(%ecx,%edx,4)
80105585:	74 19                	je     801055a0 <sys_pipe+0xa0>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105587:	83 c2 01             	add    $0x1,%edx
8010558a:	83 fa 10             	cmp    $0x10,%edx
8010558d:	75 f1                	jne    80105580 <sys_pipe+0x80>
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      proc->ofile[fd0] = 0;
8010558f:	c7 46 28 00 00 00 00 	movl   $0x0,0x28(%esi)
80105596:	eb b8                	jmp    80105550 <sys_pipe+0x50>
80105598:	90                   	nop
80105599:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
801055a0:	89 7c 91 28          	mov    %edi,0x28(%ecx,%edx,4)
      proc->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
801055a4:	8b 4d dc             	mov    -0x24(%ebp),%ecx
801055a7:	89 01                	mov    %eax,(%ecx)
  fd[1] = fd1;
...
{
  return fork();
801055c4:	e9 97 e4 ff ff       	jmp    80103a60 <fork>
...
801055d3:	83 ec 08             	sub    $0x8,%esp
  exit();
801055d6:	e8 65 e7 ff ff       	call   80103d40 <exit>
...
{
  return wait();
801055e4:	e9 a7 e9 ff ff       	jmp    80103f90 <wait>
...
801055fc:	e8 6f f2 ff ff       	call   80104870 <argint>
...
8010560e:	e8 bd ea ff ff       	call   801040d0 <kill>
...
8010565f:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = proc->sz;
80105662:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105664:	ff 75 f4             	pushl  -0xc(%ebp)
80105667:	e8 24 e3 ff ff       	call   80103990 <growproc>
8010566c:	83 c4 10             	add    $0x10,%esp
8010566f:	85 c0                	test   %eax,%eax
80105671:	78 0d                	js     80105680 <sys_sbrk+0x40>
    return -1;
  return addr;
...
80105685:	eb ee                	jmp    80105675 <sys_sbrk+0x35>
...
8010569d:	e8 ce f1 ff ff       	call   80104870 <argint>
...
801056b0:	68 e0 4d 11 80       	push   $0x80114de0
801056b5:	e8 96 ec ff ff       	call   80104350 <acquire>
  ticks0 = ticks;
...
801056bd:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
801056c0:	8b 1d 20 56 11 80    	mov    0x80115620,%ebx
  while(ticks - ticks0 < n){
...
801056d3:	68 e0 4d 11 80       	push   $0x80114de0
801056d8:	68 20 56 11 80       	push   $0x80115620
801056dd:	e8 ee e7 ff ff       	call   80103ed0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801056e2:	a1 20 56 11 80       	mov    0x80115620,%eax
...
801056f7:	8b 40 24             	mov    0x24(%eax),%eax
801056fa:	85 c0                	test   %eax,%eax
801056fc:	74 d2                	je     801056d0 <sys_sleep+0x40>
      release(&tickslock);
801056fe:	83 ec 0c             	sub    $0xc,%esp
80105701:	68 e0 4d 11 80       	push   $0x80114de0
80105706:	e8 25 ee ff ff       	call   80104530 <release>
      return -1;
...
80105713:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105716:	c9                   	leave  
80105717:	c3                   	ret    
80105718:	90                   	nop
...
80105723:	68 e0 4d 11 80       	push   $0x80114de0
80105728:	e8 03 ee ff ff       	call   80104530 <release>
  return 0;
...
8010573c:	eb d5                	jmp    80105713 <sys_sleep+0x83>
...
80105744:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105747:	68 e0 4d 11 80       	push   $0x80114de0
8010574c:	e8 ff eb ff ff       	call   80104350 <acquire>
  xticks = ticks;
80105751:	8b 1d 20 56 11 80    	mov    0x80115620,%ebx
  release(&tickslock);
80105757:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
8010575e:	e8 cd ed ff ff       	call   80104530 <release>
  return xticks;
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105771:	ba 43 00 00 00       	mov    $0x43,%edx
80105776:	b8 34 00 00 00       	mov    $0x34,%eax
8010577b:	89 e5                	mov    %esp,%ebp
8010577d:	83 ec 14             	sub    $0x14,%esp
80105780:	ee                   	out    %al,(%dx)
80105781:	ba 40 00 00 00       	mov    $0x40,%edx
80105786:	b8 9c ff ff ff       	mov    $0xffffff9c,%eax
8010578b:	ee                   	out    %al,(%dx)
8010578c:	b8 2e 00 00 00       	mov    $0x2e,%eax
...
80105794:	e8 f7 da ff ff       	call   80103290 <picenable>
}
...
8010579f:	06                   	push   %es
  pushl %fs
801057a0:	0f a0                	push   %fs
  pushl %gs
801057a2:	0f a8                	push   %gs
  pushal
801057a4:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801057a5:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801057a9:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801057ab:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801057ad:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801057b1:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801057b3:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801057b5:	54                   	push   %esp
  call trap
801057b6:	e8 e5 00 00 00       	call   801058a0 <trap>
  addl $4, %esp
...
801057d8:	8b 14 85 10 a0 10 80 	mov    -0x7fef5ff0(,%eax,4),%edx
801057df:	b9 08 00 00 00       	mov    $0x8,%ecx
801057e4:	c6 04 c5 24 4e 11 80 	movb   $0x0,-0x7feeb1dc(,%eax,8)
801057eb:	00 
801057ec:	66 89 0c c5 22 4e 11 	mov    %cx,-0x7feeb1de(,%eax,8)
801057f3:	80 
801057f4:	c6 04 c5 25 4e 11 80 	movb   $0x8e,-0x7feeb1db(,%eax,8)
801057fb:	8e 
801057fc:	66 89 14 c5 20 4e 11 	mov    %dx,-0x7feeb1e0(,%eax,8)
80105803:	80 
80105804:	c1 ea 10             	shr    $0x10,%edx
80105807:	66 89 14 c5 26 4e 11 	mov    %dx,-0x7feeb1da(,%eax,8)
8010580e:	80 
void
tvinit(void)
{
...
80105821:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105824:	a1 10 a1 10 80       	mov    0x8010a110,%eax

  initlock(&tickslock, "time");
80105829:	68 b9 77 10 80       	push   $0x801077b9
8010582e:	68 e0 4d 11 80       	push   $0x80114de0
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105833:	66 89 15 22 50 11 80 	mov    %dx,0x80115022
8010583a:	c6 05 24 50 11 80 00 	movb   $0x0,0x80115024
80105841:	66 a3 20 50 11 80    	mov    %ax,0x80115020
80105847:	c1 e8 10             	shr    $0x10,%eax
8010584a:	c6 05 25 50 11 80 ef 	movb   $0xef,0x80115025
80105851:	66 a3 26 50 11 80    	mov    %ax,0x80115026

  initlock(&tickslock, "time");
80105857:	e8 d4 ea ff ff       	call   80104330 <initlock>
}
...
8010587b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010587f:	b8 20 4e 11 80       	mov    $0x80114e20,%eax
...
801058b2:	0f 84 f8 00 00 00    	je     801059b0 <trap+0x110>
    if(proc->killed)
      exit();
    return;
  }
...
801058be:	77 68                	ja     80105928 <trap+0x88>
801058c0:	ff 24 85 60 78 10 80 	jmp    *-0x7fef87a0(,%eax,4)
801058c7:	89 f6                	mov    %esi,%esi
801058c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
801058d0:	e8 fb cd ff ff       	call   801026d0 <cpunum>
801058d5:	85 c0                	test   %eax,%eax
801058d7:	0f 84 b3 01 00 00    	je     80105a90 <trap+0x1f0>
    kbdintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_COM1:
    uartintr();
    lapiceoi();
801058dd:	e8 8e ce ff ff       	call   80102770 <lapiceoi>
  }
...
801058ea:	74 2d                	je     80105919 <trap+0x79>
801058ec:	8b 50 24             	mov    0x24(%eax),%edx
801058ef:	85 d2                	test   %edx,%edx
801058f1:	0f 85 86 00 00 00    	jne    8010597d <trap+0xdd>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
801058f7:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801058fb:	0f 84 ef 00 00 00    	je     801059f0 <trap+0x150>
    yield();
...
80105921:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80105928:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010592f:	85 c9                	test   %ecx,%ecx
80105931:	0f 84 8d 01 00 00    	je     80105ac4 <trap+0x224>
80105937:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010593b:	0f 84 83 01 00 00    	je     80105ac4 <trap+0x224>
...
80105944:	8b 73 38             	mov    0x38(%ebx),%esi
80105947:	e8 84 cd ff ff       	call   801026d0 <cpunum>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
8010594c:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
...
80105956:	ff 73 34             	pushl  0x34(%ebx)
80105959:	ff 73 30             	pushl  0x30(%ebx)
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
8010595c:	8d 42 6c             	lea    0x6c(%edx),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
...
80105960:	ff 72 10             	pushl  0x10(%edx)
80105963:	68 1c 78 10 80       	push   $0x8010781c
80105968:	e8 f3 ac ff ff       	call   80100660 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
            rcr2());
    proc->killed = 1;
...
80105976:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
  ...
  // until it gets to the regular system call return.)
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
8010597d:	0f b7 53 3c          	movzwl 0x3c(%ebx),%edx
80105981:	83 e2 03             	and    $0x3,%edx
80105984:	66 83 fa 03          	cmp    $0x3,%dx
80105988:	0f 85 69 ff ff ff    	jne    801058f7 <trap+0x57>
    exit();
8010598e:	e8 ad e3 ff ff       	call   80103d40 <exit>
...
8010599b:	0f 85 56 ff ff ff    	jne    801058f7 <trap+0x57>
801059a1:	e9 73 ff ff ff       	jmp    80105919 <trap+0x79>
...
801059b6:	8b 70 24             	mov    0x24(%eax),%esi
801059b9:	85 f6                	test   %esi,%esi
801059bb:	0f 85 bf 00 00 00    	jne    80105a80 <trap+0x1e0>
      exit();
    proc->tf = tf;
801059c1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801059c4:	e8 b7 ef ff ff       	call   80104980 <syscall>
    if(proc->killed)
801059c9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059cf:	8b 58 24             	mov    0x24(%eax),%ebx
801059d2:	85 db                	test   %ebx,%ebx
801059d4:	0f 84 3f ff ff ff    	je     80105919 <trap+0x79>
    yield();
...
801059e0:	5d                   	pop    %ebp
    ...
    if(proc->killed)
      exit();
801059e1:	e9 5a e3 ff ff       	jmp    80103d40 <exit>
...
801059f4:	0f 85 07 ff ff ff    	jne    80105901 <trap+0x61>
    yield();
801059fa:	e8 91 e4 ff ff       	call   80103e90 <yield>
801059ff:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80105a05:	85 c0                	test   %eax,%eax
80105a07:	0f 85 f4 fe ff ff    	jne    80105901 <trap+0x61>
80105a0d:	e9 07 ff ff ff       	jmp    80105919 <trap+0x79>
80105a12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105a18:	e8 93 cb ff ff       	call   801025b0 <kbdintr>
    lapiceoi();
80105a1d:	e8 4e cd ff ff       	call   80102770 <lapiceoi>
    break;
80105a22:	e9 bb fe ff ff       	jmp    801058e2 <trap+0x42>
80105a27:	89 f6                	mov    %esi,%esi
80105a29:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105a30:	e8 2b 02 00 00       	call   80105c60 <uartintr>
80105a35:	e9 a3 fe ff ff       	jmp    801058dd <trap+0x3d>
...
80105a40:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105a44:	8b 7b 38             	mov    0x38(%ebx),%edi
80105a47:	e8 84 cc ff ff       	call   801026d0 <cpunum>
80105a4c:	57                   	push   %edi
80105a4d:	56                   	push   %esi
80105a4e:	50                   	push   %eax
80105a4f:	68 c4 77 10 80       	push   $0x801077c4
80105a54:	e8 07 ac ff ff       	call   80100660 <cprintf>
            cpunum(), tf->cs, tf->eip);
    lapiceoi();
80105a59:	e8 12 cd ff ff       	call   80102770 <lapiceoi>
    break;
80105a5e:	83 c4 10             	add    $0x10,%esp
80105a61:	e9 7c fe ff ff       	jmp    801058e2 <trap+0x42>
...
80105a69:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105a70:	e8 ab c5 ff ff       	call   80102020 <ideintr>
    lapiceoi();
80105a75:	e8 f6 cc ff ff       	call   80102770 <lapiceoi>
    break;
80105a7a:	e9 63 fe ff ff       	jmp    801058e2 <trap+0x42>
80105a7f:	90                   	nop
void
trap(struct trapframe *tf)
{
...
80105a8b:	e9 31 ff ff ff       	jmp    801059c1 <trap+0x121>
  }
...
80105a93:	68 e0 4d 11 80       	push   $0x80114de0
80105a98:	e8 b3 e8 ff ff       	call   80104350 <acquire>
      ticks++;
      wakeup(&ticks);
80105a9d:	c7 04 24 20 56 11 80 	movl   $0x80115620,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
      ticks++;
80105aa4:	83 05 20 56 11 80 01 	addl   $0x1,0x80115620
      wakeup(&ticks);
80105aab:	e8 c0 e5 ff ff       	call   80104070 <wakeup>
      release(&tickslock);
80105ab0:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
80105ab7:	e8 74 ea ff ff       	call   80104530 <release>
80105abc:	83 c4 10             	add    $0x10,%esp
80105abf:	e9 19 fe ff ff       	jmp    801058dd <trap+0x3d>
80105ac4:	0f 20 d7             	mov    %cr2,%edi
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105ac7:	8b 73 38             	mov    0x38(%ebx),%esi
80105aca:	e8 01 cc ff ff       	call   801026d0 <cpunum>
80105acf:	83 ec 0c             	sub    $0xc,%esp
80105ad2:	57                   	push   %edi
80105ad3:	56                   	push   %esi
80105ad4:	50                   	push   %eax
80105ad5:	ff 73 30             	pushl  0x30(%ebx)
80105ad8:	68 e8 77 10 80       	push   $0x801077e8
80105add:	e8 7e ab ff ff       	call   80100660 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
80105ae2:	83 c4 14             	add    $0x14,%esp
80105ae5:	68 be 77 10 80       	push   $0x801077be
80105aea:	e8 81 a8 ff ff       	call   80100370 <panic>
80105aef:	90                   	nop
...
{
  if(!uart)
80105af0:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
  outb(COM1+0, c);
}
...
80105b45:	e8 46 cc ff ff       	call   80102790 <microdelay>
{
  int i;
...
80105bc7:	74 5a                	je     80105c23 <uartinit+0xb3>
    return;
  uart = 1;
80105bc9:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105bd0:	00 00 00 
...
80105bdf:	6a 04                	push   $0x4
80105be1:	e8 aa d6 ff ff       	call   80103290 <picenable>
  ioapicenable(IRQ_COM1, 0);
80105be6:	59                   	pop    %ecx
80105be7:	5b                   	pop    %ebx
80105be8:	6a 00                	push   $0x0
80105bea:	6a 04                	push   $0x4
80105bec:	bb e0 78 10 80       	mov    $0x801078e0,%ebx
80105bf1:	e8 8a c6 ff ff       	call   80102280 <ioapicenable>
80105bf6:	83 c4 10             	add    $0x10,%esp
80105bf9:	b8 78 00 00 00       	mov    $0x78,%eax
80105bfe:	eb 0a                	jmp    80105c0a <uartinit+0x9a>
...
uartputc(int c)
{
  ...
  if(!uart)
80105c0a:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
...
uartputc(int c)
{
  ...
  if(!uart)
80105c30:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
    uartputc(*p);
}
...
80105c77:	6a 00                	push   $0x0
  jmp alltraps
80105c79:	e9 20 fb ff ff       	jmp    8010579e <alltraps>
...
80105c80:	6a 01                	push   $0x1
  jmp alltraps
80105c82:	e9 17 fb ff ff       	jmp    8010579e <alltraps>
...
80105c89:	6a 02                	push   $0x2
  jmp alltraps
80105c8b:	e9 0e fb ff ff       	jmp    8010579e <alltraps>
...
80105c92:	6a 03                	push   $0x3
  jmp alltraps
80105c94:	e9 05 fb ff ff       	jmp    8010579e <alltraps>
...
80105c9b:	6a 04                	push   $0x4
  jmp alltraps
80105c9d:	e9 fc fa ff ff       	jmp    8010579e <alltraps>
...
80105ca4:	6a 05                	push   $0x5
  jmp alltraps
80105ca6:	e9 f3 fa ff ff       	jmp    8010579e <alltraps>
...
80105cad:	6a 06                	push   $0x6
  jmp alltraps
80105caf:	e9 ea fa ff ff       	jmp    8010579e <alltraps>
...
80105cb6:	6a 07                	push   $0x7
  jmp alltraps
80105cb8:	e9 e1 fa ff ff       	jmp    8010579e <alltraps>
...
80105cbd:	6a 08                	push   $0x8
  jmp alltraps
80105cbf:	e9 da fa ff ff       	jmp    8010579e <alltraps>
...
80105cc6:	6a 09                	push   $0x9
  jmp alltraps
80105cc8:	e9 d1 fa ff ff       	jmp    8010579e <alltraps>
...
80105ccd:	6a 0a                	push   $0xa
  jmp alltraps
80105ccf:	e9 ca fa ff ff       	jmp    8010579e <alltraps>
...
80105cd4:	6a 0b                	push   $0xb
  jmp alltraps
80105cd6:	e9 c3 fa ff ff       	jmp    8010579e <alltraps>
...
80105cdb:	6a 0c                	push   $0xc
  jmp alltraps
80105cdd:	e9 bc fa ff ff       	jmp    8010579e <alltraps>
...
80105ce2:	6a 0d                	push   $0xd
  jmp alltraps
80105ce4:	e9 b5 fa ff ff       	jmp    8010579e <alltraps>
...
80105ce9:	6a 0e                	push   $0xe
  jmp alltraps
80105ceb:	e9 ae fa ff ff       	jmp    8010579e <alltraps>
...
80105cf2:	6a 0f                	push   $0xf
  jmp alltraps
80105cf4:	e9 a5 fa ff ff       	jmp    8010579e <alltraps>
...
80105cfb:	6a 10                	push   $0x10
  jmp alltraps
80105cfd:	e9 9c fa ff ff       	jmp    8010579e <alltraps>
...
80105d02:	6a 11                	push   $0x11
  jmp alltraps
80105d04:	e9 95 fa ff ff       	jmp    8010579e <alltraps>
...
80105d0b:	6a 12                	push   $0x12
  jmp alltraps
80105d0d:	e9 8c fa ff ff       	jmp    8010579e <alltraps>
...
80105d14:	6a 13                	push   $0x13
  jmp alltraps
80105d16:	e9 83 fa ff ff       	jmp    8010579e <alltraps>
...
80105d1d:	6a 14                	push   $0x14
  jmp alltraps
80105d1f:	e9 7a fa ff ff       	jmp    8010579e <alltraps>
...
80105d26:	6a 15                	push   $0x15
  jmp alltraps
80105d28:	e9 71 fa ff ff       	jmp    8010579e <alltraps>
...
80105d2f:	6a 16                	push   $0x16
  jmp alltraps
80105d31:	e9 68 fa ff ff       	jmp    8010579e <alltraps>
...
80105d38:	6a 17                	push   $0x17
  jmp alltraps
80105d3a:	e9 5f fa ff ff       	jmp    8010579e <alltraps>
...
80105d41:	6a 18                	push   $0x18
  jmp alltraps
80105d43:	e9 56 fa ff ff       	jmp    8010579e <alltraps>
...
80105d4a:	6a 19                	push   $0x19
  jmp alltraps
80105d4c:	e9 4d fa ff ff       	jmp    8010579e <alltraps>
...
80105d53:	6a 1a                	push   $0x1a
  jmp alltraps
80105d55:	e9 44 fa ff ff       	jmp    8010579e <alltraps>
...
80105d5c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d5e:	e9 3b fa ff ff       	jmp    8010579e <alltraps>
...
80105d65:	6a 1c                	push   $0x1c
  jmp alltraps
80105d67:	e9 32 fa ff ff       	jmp    8010579e <alltraps>
...
80105d6e:	6a 1d                	push   $0x1d
  jmp alltraps
80105d70:	e9 29 fa ff ff       	jmp    8010579e <alltraps>
...
80105d77:	6a 1e                	push   $0x1e
  jmp alltraps
80105d79:	e9 20 fa ff ff       	jmp    8010579e <alltraps>
...
80105d80:	6a 1f                	push   $0x1f
  jmp alltraps
80105d82:	e9 17 fa ff ff       	jmp    8010579e <alltraps>
...
80105d89:	6a 20                	push   $0x20
  jmp alltraps
80105d8b:	e9 0e fa ff ff       	jmp    8010579e <alltraps>
...
80105d92:	6a 21                	push   $0x21
  jmp alltraps
80105d94:	e9 05 fa ff ff       	jmp    8010579e <alltraps>
...
80105d9b:	6a 22                	push   $0x22
  jmp alltraps
80105d9d:	e9 fc f9 ff ff       	jmp    8010579e <alltraps>
...
80105da4:	6a 23                	push   $0x23
  jmp alltraps
80105da6:	e9 f3 f9 ff ff       	jmp    8010579e <alltraps>
...
80105dad:	6a 24                	push   $0x24
  jmp alltraps
80105daf:	e9 ea f9 ff ff       	jmp    8010579e <alltraps>
...
80105db6:	6a 25                	push   $0x25
  jmp alltraps
80105db8:	e9 e1 f9 ff ff       	jmp    8010579e <alltraps>
...
80105dbf:	6a 26                	push   $0x26
  jmp alltraps
80105dc1:	e9 d8 f9 ff ff       	jmp    8010579e <alltraps>
...
80105dc8:	6a 27                	push   $0x27
  jmp alltraps
80105dca:	e9 cf f9 ff ff       	jmp    8010579e <alltraps>
...
80105dd1:	6a 28                	push   $0x28
  jmp alltraps
80105dd3:	e9 c6 f9 ff ff       	jmp    8010579e <alltraps>
...
80105dda:	6a 29                	push   $0x29
  jmp alltraps
80105ddc:	e9 bd f9 ff ff       	jmp    8010579e <alltraps>
...
80105de3:	6a 2a                	push   $0x2a
  jmp alltraps
80105de5:	e9 b4 f9 ff ff       	jmp    8010579e <alltraps>
...
80105dec:	6a 2b                	push   $0x2b
  jmp alltraps
80105dee:	e9 ab f9 ff ff       	jmp    8010579e <alltraps>
...
80105df5:	6a 2c                	push   $0x2c
  jmp alltraps
80105df7:	e9 a2 f9 ff ff       	jmp    8010579e <alltraps>
...
80105dfe:	6a 2d                	push   $0x2d
  jmp alltraps
80105e00:	e9 99 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e07:	6a 2e                	push   $0x2e
  jmp alltraps
80105e09:	e9 90 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e10:	6a 2f                	push   $0x2f
  jmp alltraps
80105e12:	e9 87 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e19:	6a 30                	push   $0x30
  jmp alltraps
80105e1b:	e9 7e f9 ff ff       	jmp    8010579e <alltraps>
...
80105e22:	6a 31                	push   $0x31
  jmp alltraps
80105e24:	e9 75 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e2b:	6a 32                	push   $0x32
  jmp alltraps
80105e2d:	e9 6c f9 ff ff       	jmp    8010579e <alltraps>
...
80105e34:	6a 33                	push   $0x33
  jmp alltraps
80105e36:	e9 63 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e3d:	6a 34                	push   $0x34
  jmp alltraps
80105e3f:	e9 5a f9 ff ff       	jmp    8010579e <alltraps>
...
80105e46:	6a 35                	push   $0x35
  jmp alltraps
80105e48:	e9 51 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e4f:	6a 36                	push   $0x36
  jmp alltraps
80105e51:	e9 48 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e58:	6a 37                	push   $0x37
  jmp alltraps
80105e5a:	e9 3f f9 ff ff       	jmp    8010579e <alltraps>
...
80105e61:	6a 38                	push   $0x38
  jmp alltraps
80105e63:	e9 36 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e6a:	6a 39                	push   $0x39
  jmp alltraps
80105e6c:	e9 2d f9 ff ff       	jmp    8010579e <alltraps>
...
80105e73:	6a 3a                	push   $0x3a
  jmp alltraps
80105e75:	e9 24 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e7c:	6a 3b                	push   $0x3b
  jmp alltraps
80105e7e:	e9 1b f9 ff ff       	jmp    8010579e <alltraps>
...
80105e85:	6a 3c                	push   $0x3c
  jmp alltraps
80105e87:	e9 12 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e8e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e90:	e9 09 f9 ff ff       	jmp    8010579e <alltraps>
...
80105e97:	6a 3e                	push   $0x3e
  jmp alltraps
80105e99:	e9 00 f9 ff ff       	jmp    8010579e <alltraps>
...
80105ea0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ea2:	e9 f7 f8 ff ff       	jmp    8010579e <alltraps>
...
80105ea9:	6a 40                	push   $0x40
  jmp alltraps
80105eab:	e9 ee f8 ff ff       	jmp    8010579e <alltraps>
...
80105eb2:	6a 41                	push   $0x41
  jmp alltraps
80105eb4:	e9 e5 f8 ff ff       	jmp    8010579e <alltraps>
...
80105ebb:	6a 42                	push   $0x42
  jmp alltraps
80105ebd:	e9 dc f8 ff ff       	jmp    8010579e <alltraps>
...
80105ec4:	6a 43                	push   $0x43
  jmp alltraps
80105ec6:	e9 d3 f8 ff ff       	jmp    8010579e <alltraps>
...
80105ecd:	6a 44                	push   $0x44
  jmp alltraps
80105ecf:	e9 ca f8 ff ff       	jmp    8010579e <alltraps>
...
80105ed6:	6a 45                	push   $0x45
  jmp alltraps
80105ed8:	e9 c1 f8 ff ff       	jmp    8010579e <alltraps>
...
80105edf:	6a 46                	push   $0x46
  jmp alltraps
80105ee1:	e9 b8 f8 ff ff       	jmp    8010579e <alltraps>
...
80105ee8:	6a 47                	push   $0x47
  jmp alltraps
80105eea:	e9 af f8 ff ff       	jmp    8010579e <alltraps>
...
80105ef1:	6a 48                	push   $0x48
  jmp alltraps
80105ef3:	e9 a6 f8 ff ff       	jmp    8010579e <alltraps>
...
80105efa:	6a 49                	push   $0x49
  jmp alltraps
80105efc:	e9 9d f8 ff ff       	jmp    8010579e <alltraps>
...
80105f03:	6a 4a                	push   $0x4a
  jmp alltraps
80105f05:	e9 94 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f0c:	6a 4b                	push   $0x4b
  jmp alltraps
80105f0e:	e9 8b f8 ff ff       	jmp    8010579e <alltraps>
...
80105f15:	6a 4c                	push   $0x4c
  jmp alltraps
80105f17:	e9 82 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f1e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f20:	e9 79 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f27:	6a 4e                	push   $0x4e
  jmp alltraps
80105f29:	e9 70 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f30:	6a 4f                	push   $0x4f
  jmp alltraps
80105f32:	e9 67 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f39:	6a 50                	push   $0x50
  jmp alltraps
80105f3b:	e9 5e f8 ff ff       	jmp    8010579e <alltraps>
...
80105f42:	6a 51                	push   $0x51
  jmp alltraps
80105f44:	e9 55 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f4b:	6a 52                	push   $0x52
  jmp alltraps
80105f4d:	e9 4c f8 ff ff       	jmp    8010579e <alltraps>
...
80105f54:	6a 53                	push   $0x53
  jmp alltraps
80105f56:	e9 43 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f5d:	6a 54                	push   $0x54
  jmp alltraps
80105f5f:	e9 3a f8 ff ff       	jmp    8010579e <alltraps>
...
80105f66:	6a 55                	push   $0x55
  jmp alltraps
80105f68:	e9 31 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f6f:	6a 56                	push   $0x56
  jmp alltraps
80105f71:	e9 28 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f78:	6a 57                	push   $0x57
  jmp alltraps
80105f7a:	e9 1f f8 ff ff       	jmp    8010579e <alltraps>
...
80105f81:	6a 58                	push   $0x58
  jmp alltraps
80105f83:	e9 16 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f8a:	6a 59                	push   $0x59
  jmp alltraps
80105f8c:	e9 0d f8 ff ff       	jmp    8010579e <alltraps>
...
80105f93:	6a 5a                	push   $0x5a
  jmp alltraps
80105f95:	e9 04 f8 ff ff       	jmp    8010579e <alltraps>
...
80105f9c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f9e:	e9 fb f7 ff ff       	jmp    8010579e <alltraps>
...
80105fa5:	6a 5c                	push   $0x5c
  jmp alltraps
80105fa7:	e9 f2 f7 ff ff       	jmp    8010579e <alltraps>
...
80105fae:	6a 5d                	push   $0x5d
  jmp alltraps
80105fb0:	e9 e9 f7 ff ff       	jmp    8010579e <alltraps>
...
80105fb7:	6a 5e                	push   $0x5e
  jmp alltraps
80105fb9:	e9 e0 f7 ff ff       	jmp    8010579e <alltraps>
...
80105fc0:	6a 5f                	push   $0x5f
  jmp alltraps
80105fc2:	e9 d7 f7 ff ff       	jmp    8010579e <alltraps>
...
80105fc9:	6a 60                	push   $0x60
  jmp alltraps
80105fcb:	e9 ce f7 ff ff       	jmp    8010579e <alltraps>
...
80105fd2:	6a 61                	push   $0x61
  jmp alltraps
80105fd4:	e9 c5 f7 ff ff       	jmp    8010579e <alltraps>
...
80105fdb:	6a 62                	push   $0x62
  jmp alltraps
80105fdd:	e9 bc f7 ff ff       	jmp    8010579e <alltraps>
...
80105fe4:	6a 63                	push   $0x63
  jmp alltraps
80105fe6:	e9 b3 f7 ff ff       	jmp    8010579e <alltraps>
...
80105fed:	6a 64                	push   $0x64
  jmp alltraps
80105fef:	e9 aa f7 ff ff       	jmp    8010579e <alltraps>
...
80105ff6:	6a 65                	push   $0x65
  jmp alltraps
80105ff8:	e9 a1 f7 ff ff       	jmp    8010579e <alltraps>
...
80105fff:	6a 66                	push   $0x66
  jmp alltraps
80106001:	e9 98 f7 ff ff       	jmp    8010579e <alltraps>
...
80106008:	6a 67                	push   $0x67
  jmp alltraps
8010600a:	e9 8f f7 ff ff       	jmp    8010579e <alltraps>
...
80106011:	6a 68                	push   $0x68
  jmp alltraps
80106013:	e9 86 f7 ff ff       	jmp    8010579e <alltraps>
...
8010601a:	6a 69                	push   $0x69
  jmp alltraps
8010601c:	e9 7d f7 ff ff       	jmp    8010579e <alltraps>
...
80106023:	6a 6a                	push   $0x6a
  jmp alltraps
80106025:	e9 74 f7 ff ff       	jmp    8010579e <alltraps>
...
8010602c:	6a 6b                	push   $0x6b
  jmp alltraps
8010602e:	e9 6b f7 ff ff       	jmp    8010579e <alltraps>
...
80106035:	6a 6c                	push   $0x6c
  jmp alltraps
80106037:	e9 62 f7 ff ff       	jmp    8010579e <alltraps>
...
8010603e:	6a 6d                	push   $0x6d
  jmp alltraps
80106040:	e9 59 f7 ff ff       	jmp    8010579e <alltraps>
...
80106047:	6a 6e                	push   $0x6e
  jmp alltraps
80106049:	e9 50 f7 ff ff       	jmp    8010579e <alltraps>
...
80106050:	6a 6f                	push   $0x6f
  jmp alltraps
80106052:	e9 47 f7 ff ff       	jmp    8010579e <alltraps>
...
80106059:	6a 70                	push   $0x70
  jmp alltraps
8010605b:	e9 3e f7 ff ff       	jmp    8010579e <alltraps>
...
80106062:	6a 71                	push   $0x71
  jmp alltraps
80106064:	e9 35 f7 ff ff       	jmp    8010579e <alltraps>
...
8010606b:	6a 72                	push   $0x72
  jmp alltraps
8010606d:	e9 2c f7 ff ff       	jmp    8010579e <alltraps>
...
80106074:	6a 73                	push   $0x73
  jmp alltraps
80106076:	e9 23 f7 ff ff       	jmp    8010579e <alltraps>
...
8010607d:	6a 74                	push   $0x74
  jmp alltraps
8010607f:	e9 1a f7 ff ff       	jmp    8010579e <alltraps>
...
80106086:	6a 75                	push   $0x75
  jmp alltraps
80106088:	e9 11 f7 ff ff       	jmp    8010579e <alltraps>
...
8010608f:	6a 76                	push   $0x76
  jmp alltraps
80106091:	e9 08 f7 ff ff       	jmp    8010579e <alltraps>
...
80106098:	6a 77                	push   $0x77
  jmp alltraps
8010609a:	e9 ff f6 ff ff       	jmp    8010579e <alltraps>
...
801060a1:	6a 78                	push   $0x78
  jmp alltraps
801060a3:	e9 f6 f6 ff ff       	jmp    8010579e <alltraps>
...
801060aa:	6a 79                	push   $0x79
  jmp alltraps
801060ac:	e9 ed f6 ff ff       	jmp    8010579e <alltraps>
...
801060b3:	6a 7a                	push   $0x7a
  jmp alltraps
801060b5:	e9 e4 f6 ff ff       	jmp    8010579e <alltraps>
...
801060bc:	6a 7b                	push   $0x7b
  jmp alltraps
801060be:	e9 db f6 ff ff       	jmp    8010579e <alltraps>
...
801060c5:	6a 7c                	push   $0x7c
  jmp alltraps
801060c7:	e9 d2 f6 ff ff       	jmp    8010579e <alltraps>
...
801060ce:	6a 7d                	push   $0x7d
  jmp alltraps
801060d0:	e9 c9 f6 ff ff       	jmp    8010579e <alltraps>
...
801060d7:	6a 7e                	push   $0x7e
  jmp alltraps
801060d9:	e9 c0 f6 ff ff       	jmp    8010579e <alltraps>
...
801060e0:	6a 7f                	push   $0x7f
  jmp alltraps
801060e2:	e9 b7 f6 ff ff       	jmp    8010579e <alltraps>
...
801060e9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801060ee:	e9 ab f6 ff ff       	jmp    8010579e <alltraps>
...
801060f5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801060fa:	e9 9f f6 ff ff       	jmp    8010579e <alltraps>
...
80106101:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106106:	e9 93 f6 ff ff       	jmp    8010579e <alltraps>
...
8010610d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106112:	e9 87 f6 ff ff       	jmp    8010579e <alltraps>
...
80106119:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010611e:	e9 7b f6 ff ff       	jmp    8010579e <alltraps>
...
80106125:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010612a:	e9 6f f6 ff ff       	jmp    8010579e <alltraps>
...
80106131:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106136:	e9 63 f6 ff ff       	jmp    8010579e <alltraps>
...
8010613d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106142:	e9 57 f6 ff ff       	jmp    8010579e <alltraps>
...
80106149:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010614e:	e9 4b f6 ff ff       	jmp    8010579e <alltraps>
...
80106155:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010615a:	e9 3f f6 ff ff       	jmp    8010579e <alltraps>
...
80106161:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106166:	e9 33 f6 ff ff       	jmp    8010579e <alltraps>
...
8010616d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106172:	e9 27 f6 ff ff       	jmp    8010579e <alltraps>
...
80106179:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010617e:	e9 1b f6 ff ff       	jmp    8010579e <alltraps>
...
80106185:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010618a:	e9 0f f6 ff ff       	jmp    8010579e <alltraps>
...
80106191:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106196:	e9 03 f6 ff ff       	jmp    8010579e <alltraps>
...
8010619d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801061a2:	e9 f7 f5 ff ff       	jmp    8010579e <alltraps>
...
801061a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801061ae:	e9 eb f5 ff ff       	jmp    8010579e <alltraps>
...
801061b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801061ba:	e9 df f5 ff ff       	jmp    8010579e <alltraps>
...
801061c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801061c6:	e9 d3 f5 ff ff       	jmp    8010579e <alltraps>
...
801061cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801061d2:	e9 c7 f5 ff ff       	jmp    8010579e <alltraps>
...
801061d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801061de:	e9 bb f5 ff ff       	jmp    8010579e <alltraps>
...
801061e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801061ea:	e9 af f5 ff ff       	jmp    8010579e <alltraps>
...
801061f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801061f6:	e9 a3 f5 ff ff       	jmp    8010579e <alltraps>
...
801061fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106202:	e9 97 f5 ff ff       	jmp    8010579e <alltraps>
...
80106209:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010620e:	e9 8b f5 ff ff       	jmp    8010579e <alltraps>
...
80106215:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010621a:	e9 7f f5 ff ff       	jmp    8010579e <alltraps>
...
80106221:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106226:	e9 73 f5 ff ff       	jmp    8010579e <alltraps>
...
8010622d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106232:	e9 67 f5 ff ff       	jmp    8010579e <alltraps>
...
80106239:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010623e:	e9 5b f5 ff ff       	jmp    8010579e <alltraps>
...
80106245:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010624a:	e9 4f f5 ff ff       	jmp    8010579e <alltraps>
...
80106251:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106256:	e9 43 f5 ff ff       	jmp    8010579e <alltraps>
...
8010625d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106262:	e9 37 f5 ff ff       	jmp    8010579e <alltraps>
...
80106269:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010626e:	e9 2b f5 ff ff       	jmp    8010579e <alltraps>
...
80106275:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010627a:	e9 1f f5 ff ff       	jmp    8010579e <alltraps>
...
80106281:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106286:	e9 13 f5 ff ff       	jmp    8010579e <alltraps>
...
8010628d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106292:	e9 07 f5 ff ff       	jmp    8010579e <alltraps>
...
80106299:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010629e:	e9 fb f4 ff ff       	jmp    8010579e <alltraps>
...
801062a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801062aa:	e9 ef f4 ff ff       	jmp    8010579e <alltraps>
...
801062b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801062b6:	e9 e3 f4 ff ff       	jmp    8010579e <alltraps>
...
801062bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801062c2:	e9 d7 f4 ff ff       	jmp    8010579e <alltraps>
...
801062c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801062ce:	e9 cb f4 ff ff       	jmp    8010579e <alltraps>
...
801062d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801062da:	e9 bf f4 ff ff       	jmp    8010579e <alltraps>
...
801062e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801062e6:	e9 b3 f4 ff ff       	jmp    8010579e <alltraps>
...
801062ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801062f2:	e9 a7 f4 ff ff       	jmp    8010579e <alltraps>
...
801062f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801062fe:	e9 9b f4 ff ff       	jmp    8010579e <alltraps>
...
80106305:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010630a:	e9 8f f4 ff ff       	jmp    8010579e <alltraps>
...
80106311:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106316:	e9 83 f4 ff ff       	jmp    8010579e <alltraps>
...
8010631d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106322:	e9 77 f4 ff ff       	jmp    8010579e <alltraps>
...
80106329:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010632e:	e9 6b f4 ff ff       	jmp    8010579e <alltraps>
...
80106335:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010633a:	e9 5f f4 ff ff       	jmp    8010579e <alltraps>
...
80106341:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106346:	e9 53 f4 ff ff       	jmp    8010579e <alltraps>
...
8010634d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106352:	e9 47 f4 ff ff       	jmp    8010579e <alltraps>
...
80106359:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010635e:	e9 3b f4 ff ff       	jmp    8010579e <alltraps>
...
80106365:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010636a:	e9 2f f4 ff ff       	jmp    8010579e <alltraps>
...
80106371:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106376:	e9 23 f4 ff ff       	jmp    8010579e <alltraps>
...
8010637d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106382:	e9 17 f4 ff ff       	jmp    8010579e <alltraps>
...
80106389:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010638e:	e9 0b f4 ff ff       	jmp    8010579e <alltraps>
...
80106395:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010639a:	e9 ff f3 ff ff       	jmp    8010579e <alltraps>
...
801063a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801063a6:	e9 f3 f3 ff ff       	jmp    8010579e <alltraps>
...
801063ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801063b2:	e9 e7 f3 ff ff       	jmp    8010579e <alltraps>
...
801063b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801063be:	e9 db f3 ff ff       	jmp    8010579e <alltraps>
...
801063c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801063ca:	e9 cf f3 ff ff       	jmp    8010579e <alltraps>
...
801063d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801063d6:	e9 c3 f3 ff ff       	jmp    8010579e <alltraps>
...
801063dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801063e2:	e9 b7 f3 ff ff       	jmp    8010579e <alltraps>
...
801063e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801063ee:	e9 ab f3 ff ff       	jmp    8010579e <alltraps>
...
801063f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801063fa:	e9 9f f3 ff ff       	jmp    8010579e <alltraps>
...
80106401:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106406:	e9 93 f3 ff ff       	jmp    8010579e <alltraps>
...
8010640d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106412:	e9 87 f3 ff ff       	jmp    8010579e <alltraps>
...
80106419:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010641e:	e9 7b f3 ff ff       	jmp    8010579e <alltraps>
...
80106425:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010642a:	e9 6f f3 ff ff       	jmp    8010579e <alltraps>
...
80106431:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106436:	e9 63 f3 ff ff       	jmp    8010579e <alltraps>
...
8010643d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106442:	e9 57 f3 ff ff       	jmp    8010579e <alltraps>
...
80106449:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010644e:	e9 4b f3 ff ff       	jmp    8010579e <alltraps>
...
80106455:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010645a:	e9 3f f3 ff ff       	jmp    8010579e <alltraps>
...
80106461:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106466:	e9 33 f3 ff ff       	jmp    8010579e <alltraps>
...
8010646d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106472:	e9 27 f3 ff ff       	jmp    8010579e <alltraps>
...
80106479:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010647e:	e9 1b f3 ff ff       	jmp    8010579e <alltraps>
...
80106485:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010648a:	e9 0f f3 ff ff       	jmp    8010579e <alltraps>
...
80106491:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106496:	e9 03 f3 ff ff       	jmp    8010579e <alltraps>
...
8010649d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801064a2:	e9 f7 f2 ff ff       	jmp    8010579e <alltraps>
...
801064a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801064ae:	e9 eb f2 ff ff       	jmp    8010579e <alltraps>
...
801064b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801064ba:	e9 df f2 ff ff       	jmp    8010579e <alltraps>
...
801064c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801064c6:	e9 d3 f2 ff ff       	jmp    8010579e <alltraps>
...
801064cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801064d2:	e9 c7 f2 ff ff       	jmp    8010579e <alltraps>
...
801064d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801064de:	e9 bb f2 ff ff       	jmp    8010579e <alltraps>
...
801064e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801064ea:	e9 af f2 ff ff       	jmp    8010579e <alltraps>
...
801064f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801064f6:	e9 a3 f2 ff ff       	jmp    8010579e <alltraps>
...
801064fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106502:	e9 97 f2 ff ff       	jmp    8010579e <alltraps>
...
80106509:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010650e:	e9 8b f2 ff ff       	jmp    8010579e <alltraps>
...
80106515:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010651a:	e9 7f f2 ff ff       	jmp    8010579e <alltraps>
...
80106521:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106526:	e9 73 f2 ff ff       	jmp    8010579e <alltraps>
...
8010652d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106532:	e9 67 f2 ff ff       	jmp    8010579e <alltraps>
...
80106539:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010653e:	e9 5b f2 ff ff       	jmp    8010579e <alltraps>
...
80106545:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010654a:	e9 4f f2 ff ff       	jmp    8010579e <alltraps>
...
80106551:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106556:	e9 43 f2 ff ff       	jmp    8010579e <alltraps>
...
8010655d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106562:	e9 37 f2 ff ff       	jmp    8010579e <alltraps>
...
80106569:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010656e:	e9 2b f2 ff ff       	jmp    8010579e <alltraps>
...
80106575:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010657a:	e9 1f f2 ff ff       	jmp    8010579e <alltraps>
...
80106581:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106586:	e9 13 f2 ff ff       	jmp    8010579e <alltraps>
...
8010658d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106592:	e9 07 f2 ff ff       	jmp    8010579e <alltraps>
...
80106599:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010659e:	e9 fb f1 ff ff       	jmp    8010579e <alltraps>
...
801065a5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801065aa:	e9 ef f1 ff ff       	jmp    8010579e <alltraps>
...
801065b1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801065b6:	e9 e3 f1 ff ff       	jmp    8010579e <alltraps>
...
801065bd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801065c2:	e9 d7 f1 ff ff       	jmp    8010579e <alltraps>
...
801065c9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801065ce:	e9 cb f1 ff ff       	jmp    8010579e <alltraps>
...
801065d5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801065da:	e9 bf f1 ff ff       	jmp    8010579e <alltraps>
...
801065e1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801065e6:	e9 b3 f1 ff ff       	jmp    8010579e <alltraps>
...
801065ed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801065f2:	e9 a7 f1 ff ff       	jmp    8010579e <alltraps>
...
801065f9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801065fe:	e9 9b f1 ff ff       	jmp    8010579e <alltraps>
...
80106605:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010660a:	e9 8f f1 ff ff       	jmp    8010579e <alltraps>
...
80106611:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106616:	e9 83 f1 ff ff       	jmp    8010579e <alltraps>
...
8010661d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106622:	e9 77 f1 ff ff       	jmp    8010579e <alltraps>
...
80106629:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010662e:	e9 6b f1 ff ff       	jmp    8010579e <alltraps>
...
80106635:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010663a:	e9 5f f1 ff ff       	jmp    8010579e <alltraps>
...
80106641:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106646:	e9 53 f1 ff ff       	jmp    8010579e <alltraps>
...
8010664d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106652:	e9 47 f1 ff ff       	jmp    8010579e <alltraps>
...
80106659:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010665e:	e9 3b f1 ff ff       	jmp    8010579e <alltraps>
...
80106665:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010666a:	e9 2f f1 ff ff       	jmp    8010579e <alltraps>
...
80106671:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106676:	e9 23 f1 ff ff       	jmp    8010579e <alltraps>
...
8010667d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106682:	e9 17 f1 ff ff       	jmp    8010579e <alltraps>
...
80106689:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010668e:	e9 0b f1 ff ff       	jmp    8010579e <alltraps>
...
80106695:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010669a:	e9 ff f0 ff ff       	jmp    8010579e <alltraps>
...
801066a1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801066a6:	e9 f3 f0 ff ff       	jmp    8010579e <alltraps>
...
801066ad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801066b2:	e9 e7 f0 ff ff       	jmp    8010579e <alltraps>
...
801066b9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801066be:	e9 db f0 ff ff       	jmp    8010579e <alltraps>
...
801066c5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801066ca:	e9 cf f0 ff ff       	jmp    8010579e <alltraps>
...
801066d1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801066d6:	e9 c3 f0 ff ff       	jmp    8010579e <alltraps>
...
801066dd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801066e2:	e9 b7 f0 ff ff       	jmp    8010579e <alltraps>
...
80106734:	e8 37 bd ff ff       	call   80102470 <kalloc>
...
8010674a:	e8 31 de ff ff       	call   80104580 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801067ed:	68 e8 78 10 80       	push   $0x801078e8
...
80106844:	e8 77 ba ff ff       	call   801022c0 <kfree>
      *pte = 0;
...
80106892:	68 b2 72 10 80       	push   $0x801072b2
80106897:	e8 d4 9a ff ff       	call   80100370 <panic>
...
seginit(void)
{
801068a6:	83 ec 14             	sub    $0x14,%esp
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
801068a9:	e8 22 be ff ff       	call   801026d0 <cpunum>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801068ae:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801068b4:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
801068b9:	8d 90 a0 27 11 80    	lea    -0x7feed860(%eax),%edx
801068bf:	c6 80 1d 28 11 80 9a 	movb   $0x9a,-0x7feed7e3(%eax)
801068c6:	c6 80 1e 28 11 80 cf 	movb   $0xcf,-0x7feed7e2(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068cd:	c6 80 25 28 11 80 92 	movb   $0x92,-0x7feed7db(%eax)
801068d4:	c6 80 26 28 11 80 cf 	movb   $0xcf,-0x7feed7da(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801068db:	66 89 4a 78          	mov    %cx,0x78(%edx)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068df:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801068e4:	66 89 5a 7a          	mov    %bx,0x7a(%edx)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068e8:	66 89 8a 80 00 00 00 	mov    %cx,0x80(%edx)
801068ef:	31 db                	xor    %ebx,%ebx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068f1:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068f6:	66 89 9a 82 00 00 00 	mov    %bx,0x82(%edx)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068fd:	66 89 8a 90 00 00 00 	mov    %cx,0x90(%edx)
80106904:	31 db                	xor    %ebx,%ebx
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106906:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010690b:	66 89 9a 92 00 00 00 	mov    %bx,0x92(%edx)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106912:	31 db                	xor    %ebx,%ebx
80106914:	66 89 8a 98 00 00 00 	mov    %cx,0x98(%edx)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010691b:	8d 88 54 28 11 80    	lea    -0x7feed7ac(%eax),%ecx
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106921:	66 89 9a 9a 00 00 00 	mov    %bx,0x9a(%edx)
...
80106928:	31 db                	xor    %ebx,%ebx
  ...
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010692a:	c6 80 35 28 11 80 fa 	movb   $0xfa,-0x7feed7cb(%eax)
80106931:	c6 80 36 28 11 80 cf 	movb   $0xcf,-0x7feed7ca(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80106938:	66 89 9a 88 00 00 00 	mov    %bx,0x88(%edx)
8010693f:	66 89 8a 8a 00 00 00 	mov    %cx,0x8a(%edx)
80106946:	89 cb                	mov    %ecx,%ebx
80106948:	c1 e9 18             	shr    $0x18,%ecx
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010694b:	c6 80 3d 28 11 80 f2 	movb   $0xf2,-0x7feed7c3(%eax)
80106952:	c6 80 3e 28 11 80 cf 	movb   $0xcf,-0x7feed7c2(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80106959:	88 8a 8f 00 00 00    	mov    %cl,0x8f(%edx)
8010695f:	c6 80 2d 28 11 80 92 	movb   $0x92,-0x7feed7d3(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80106966:	b9 37 00 00 00       	mov    $0x37,%ecx
8010696b:	c6 80 2e 28 11 80 c0 	movb   $0xc0,-0x7feed7d2(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80106972:	05 10 28 11 80       	add    $0x80112810,%eax
80106977:	66 89 4d f2          	mov    %cx,-0xe(%ebp)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
  ...
  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010697b:	c1 eb 10             	shr    $0x10,%ebx
  pd[1] = (uint)p;
8010697e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106982:	c1 e8 10             	shr    $0x10,%eax
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106985:	c6 42 7c 00          	movb   $0x0,0x7c(%edx)
80106989:	c6 42 7f 00          	movb   $0x0,0x7f(%edx)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010698d:	c6 82 84 00 00 00 00 	movb   $0x0,0x84(%edx)
80106994:	c6 82 87 00 00 00 00 	movb   $0x0,0x87(%edx)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010699b:	c6 82 94 00 00 00 00 	movb   $0x0,0x94(%edx)
801069a2:	c6 82 97 00 00 00 00 	movb   $0x0,0x97(%edx)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801069a9:	c6 82 9c 00 00 00 00 	movb   $0x0,0x9c(%edx)
801069b0:	c6 82 9f 00 00 00 00 	movb   $0x0,0x9f(%edx)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801069b7:	88 9a 8c 00 00 00    	mov    %bl,0x8c(%edx)
801069bd:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
801069c1:	8d 45 f2             	lea    -0xe(%ebp),%eax
801069c4:	0f 01 10             	lgdtl  (%eax)
}
...
801069c7:	b8 18 00 00 00       	mov    $0x18,%eax
801069cc:	8e e8                	mov    %eax,%gs
  lgdt(c->gdt, sizeof(c->gdt));
  loadgs(SEG_KCPU << 3);
  ...
  cpu = c;
  proc = 0;
801069ce:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801069d5:	00 00 00 00 
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
801069d9:	65 89 15 00 00 00 00 	mov    %edx,%gs:0x0
  loadgs(SEG_KCPU << 3);
...
801069e0:	83 c4 14             	add    $0x14,%esp
801069e3:	5b                   	pop    %ebx
801069e4:	5d                   	pop    %ebp
801069e5:	c3                   	ret    
...
801069f5:	e8 76 ba ff ff       	call   80102470 <kalloc>
801069fa:	85 c0                	test   %eax,%eax
801069fc:	74 52                	je     80106a50 <setupkvm+0x60>
    return 0;
  memset(pgdir, 0, PGSIZE);
801069fe:	83 ec 04             	sub    $0x4,%esp
80106a01:	89 c6                	mov    %eax,%esi
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106a03:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  pde_t *pgdir;
  struct kmap *k;
  ...
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
80106a08:	68 00 10 00 00       	push   $0x1000
80106a0d:	6a 00                	push   $0x0
80106a0f:	50                   	push   %eax
80106a10:	e8 6b db ff ff       	call   80104580 <memset>
...
80106a1b:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106a1e:	83 ec 08             	sub    $0x8,%esp
80106a21:	8b 13                	mov    (%ebx),%edx
80106a23:	ff 73 0c             	pushl  0xc(%ebx)
80106a26:	50                   	push   %eax
80106a27:	29 c1                	sub    %eax,%ecx
80106a29:	89 f0                	mov    %esi,%eax
80106a2b:	e8 40 fd ff ff       	call   80106770 <mappages>
80106a30:	83 c4 10             	add    $0x10,%esp
80106a33:	85 c0                	test   %eax,%eax
80106a35:	78 19                	js     80106a50 <setupkvm+0x60>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106a37:	83 c3 10             	add    $0x10,%ebx
80106a3a:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106a40:	75 d6                	jne    80106a18 <setupkvm+0x28>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
...
80106a63:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106a66:	e8 85 ff ff ff       	call   801069f0 <setupkvm>
80106a6b:	a3 24 56 11 80       	mov    %eax,0x80115624
}
...
80106a80 <switchkvm>:
80106a80:	a1 24 56 11 80       	mov    0x80115624,%eax
...
80106aa7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(p == 0)
80106aaa:	85 db                	test   %ebx,%ebx
80106aac:	0f 84 93 00 00 00    	je     80106b45 <switchuvm+0xa5>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106ab2:	8b 43 08             	mov    0x8(%ebx),%eax
80106ab5:	85 c0                	test   %eax,%eax
80106ab7:	0f 84 a2 00 00 00    	je     80106b5f <switchuvm+0xbf>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106abd:	8b 43 04             	mov    0x4(%ebx),%eax
80106ac0:	85 c0                	test   %eax,%eax
80106ac2:	0f 84 8a 00 00 00    	je     80106b52 <switchuvm+0xb2>
    panic("switchuvm: no pgdir");

  pushcli();
80106ac8:	e8 e3 d9 ff ff       	call   801044b0 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106acd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106ad3:	b9 67 00 00 00       	mov    $0x67,%ecx
80106ad8:	8d 50 08             	lea    0x8(%eax),%edx
80106adb:	66 89 88 a0 00 00 00 	mov    %cx,0xa0(%eax)
80106ae2:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80106ae9:	c6 80 a5 00 00 00 89 	movb   $0x89,0xa5(%eax)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
  ...
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106af0:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
80106af7:	89 d1                	mov    %edx,%ecx
80106af9:	c1 ea 18             	shr    $0x18,%edx
80106afc:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
80106b02:	c1 e9 10             	shr    $0x10,%ecx
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
80106b05:	ba 10 00 00 00       	mov    $0x10,%edx
80106b0a:	66 89 50 10          	mov    %dx,0x10(%eax)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
  ...
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106b0e:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106b14:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106b17:	8d 91 00 10 00 00    	lea    0x1000(%ecx),%edx
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
80106b1d:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
80106b22:	66 89 48 6e          	mov    %cx,0x6e(%eax)
  ...
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106b26:	89 50 0c             	mov    %edx,0xc(%eax)
}
...
80106b29:	b8 30 00 00 00       	mov    $0x30,%eax
80106b2e:	0f 00 d8             	ltr    %ax
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106b31:	8b 43 04             	mov    0x4(%ebx),%eax
80106b34:	05 00 00 00 80       	add    $0x80000000,%eax
80106b39:	0f 22 d8             	mov    %eax,%cr3
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
...
80106b3c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106b3f:	c9                   	leave  
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106b40:	e9 9b d9 ff ff       	jmp    801044e0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106b48:	68 ee 78 10 80       	push   $0x801078ee
...
80106b55:	68 19 79 10 80       	push   $0x80107919
80106b5a:	e8 11 98 ff ff       	call   80100370 <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
...
80106b62:	68 04 79 10 80       	push   $0x80107904
80106b67:	e8 04 98 ff ff       	call   80100370 <panic>
...
80106b8b:	77 49                	ja     80106bd6 <inituvm+0x66>
  ...
  mem = kalloc();
80106b8d:	e8 de b8 ff ff       	call   80102470 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b9f:	e8 dc d9 ff ff       	call   80104580 <memset>
...
80106bb9:	e8 b2 fb ff ff       	call   80106770 <mappages>
  memmove(mem, init, sz);
...
80106bd0:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106bd1:	e9 5a da ff ff       	jmp    80104630 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106bd9:	68 2d 79 10 80       	push   $0x8010792d
...
80106c33:	e8 b8 fa ff ff       	call   801066f0 <walkpgdir>
...
80106c61:	e8 aa ac ff ff       	call   80101910 <readi>
...
80106c8d:	68 47 79 10 80       	push   $0x80107947
...
80106c9a:	68 e8 79 10 80       	push   $0x801079e8
...
80106cf3:	e8 88 d8 ff ff       	call   80104580 <memset>
...
80106d0d:	e8 5e fa ff ff       	call   80106770 <mappages>
...
80106d21:	76 7d                	jbe    80106da0 <allocuvm+0xf0>
    mem = kalloc();
80106d23:	e8 48 b7 ff ff       	call   80102470 <kalloc>
    if(mem == 0){
...
80106d31:	68 65 79 10 80       	push   $0x80107965
...
80106d4b:	e8 b0 fa ff ff       	call   80106800 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106d63:	68 7d 79 10 80       	push   $0x8010797d
...
80106d7d:	e8 7e fa ff ff       	call   80106800 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106d86:	e8 35 b5 ff ff       	call   801022c0 <kfree>
      return 0;
...
80106dc0:	5d                   	pop    %ebp
80106dc1:	e9 3a fa ff ff       	jmp    80106800 <deallocuvm.part.0>
...
80106df9:	e8 02 fa ff ff       	call   80106800 <deallocuvm.part.0>
...
80106e2e:	e8 8d b4 ff ff       	call   801022c0 <kfree>
...
80106e43:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106e44:	e9 77 b4 ff ff       	jmp    801022c0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106e4c:	68 99 79 10 80       	push   $0x80107999
...
80106e7f:	68 aa 79 10 80       	push   $0x801079aa
...
80106e96:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106e99:	e8 52 fb ff ff       	call   801069f0 <setupkvm>
80106e9e:	85 c0                	test   %eax,%eax
80106ea0:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106ea3:	0f 84 b2 00 00 00    	je     80106f5b <copyuvm+0xcb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106ed0:	e8 5b d7 ff ff       	call   80104630 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106ed5:	58                   	pop    %eax
80106ed6:	5a                   	pop    %edx
80106ed7:	8d 93 00 00 00 80    	lea    -0x80000000(%ebx),%edx
80106edd:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106ee0:	ff 75 e4             	pushl  -0x1c(%ebp)
80106ee3:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106ee8:	52                   	push   %edx
80106ee9:	89 f2                	mov    %esi,%edx
80106eeb:	e8 80 f8 ff ff       	call   80106770 <mappages>
80106ef0:	83 c4 10             	add    $0x10,%esp
80106ef3:	85 c0                	test   %eax,%eax
80106ef5:	78 3e                	js     80106f35 <copyuvm+0xa5>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106ef7:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106efd:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106f00:	76 4e                	jbe    80106f50 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106f02:	8b 45 08             	mov    0x8(%ebp),%eax
80106f05:	31 c9                	xor    %ecx,%ecx
80106f07:	89 f2                	mov    %esi,%edx
80106f09:	e8 e2 f7 ff ff       	call   801066f0 <walkpgdir>
80106f0e:	85 c0                	test   %eax,%eax
80106f10:	74 5a                	je     80106f6c <copyuvm+0xdc>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106f12:	8b 18                	mov    (%eax),%ebx
80106f14:	f6 c3 01             	test   $0x1,%bl
80106f17:	74 46                	je     80106f5f <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106f19:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106f1b:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
80106f21:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106f24:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106f2a:	e8 41 b5 ff ff       	call   80102470 <kalloc>
80106f2f:	85 c0                	test   %eax,%eax
80106f31:	89 c3                	mov    %eax,%ebx
80106f33:	75 8b                	jne    80106ec0 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
80106f38:	ff 75 e0             	pushl  -0x20(%ebp)
80106f3b:	e8 a0 fe ff ff       	call   80106de0 <freevm>
  return 0;
...
80106f5d:	eb e6                	jmp    80106f45 <copyuvm+0xb5>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106f62:	68 ce 79 10 80       	push   $0x801079ce
...
80106f6f:	68 b4 79 10 80       	push   $0x801079b4
...
80106f8e:	e8 5d f7 ff ff       	call   801066f0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106fff:	e8 2c d6 ff ff       	call   80104630 <memmove>
    len -= n;
    buf += n;
